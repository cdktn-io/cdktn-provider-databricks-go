...
// Represents a {@link https://registry.terraform.io/providers/databricks/databricks/1.126.0/docs/resources/user_role databricks_user_role}.
...
func (j *jsiiProxy_UserRole) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_UserRole) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func (j *jsiiProxy_UserRole) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_UserRole) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_UserRole) Role() *string {
	var returns *string
	_jsii_.Get(
		j,
		"role",
...
func (j *jsiiProxy_UserRole) RoleInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"roleInput",
...
func (j *jsiiProxy_UserRole) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/databricks/databricks/1.126.0/docs/resources/user_role databricks_user_role} Resource.
...
func (j *jsiiProxy_UserRole)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_UserRole)SetId(val *string) {
...
func (j *jsiiProxy_UserRole)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_UserRole)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func (j *jsiiProxy_UserRole)SetRole(val *string) {
...
func UserRole_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (u *jsiiProxy_UserRole) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (u *jsiiProxy_UserRole) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (u *jsiiProxy_UserRole) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (u *jsiiProxy_UserRole) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (u *jsiiProxy_UserRole) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
