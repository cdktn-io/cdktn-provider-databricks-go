...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*UserRole)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*UserRoleConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktn/provider-databricks.userRole.UserRoleProviderConfig",
		reflect.TypeOf((*UserRoleProviderConfig)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktn/provider-databricks.userRole.UserRoleProviderConfigOutputReference",
		reflect.TypeOf((*UserRoleProviderConfigOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
