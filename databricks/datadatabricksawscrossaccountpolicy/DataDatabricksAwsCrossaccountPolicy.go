...
// Represents a {@link https://registry.terraform.io/providers/databricks/databricks/1.120.0/docs/data-sources/aws_crossaccount_policy databricks_aws_crossaccount_policy}.
...
// Create a new {@link https://registry.terraform.io/providers/databricks/databricks/1.120.0/docs/data-sources/aws_crossaccount_policy databricks_aws_crossaccount_policy} Data Source.
...
func (d *jsiiProxy_DataDatabricksAwsCrossaccountPolicy) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (d *jsiiProxy_DataDatabricksAwsCrossaccountPolicy) ToHclTerraform() interface{} {
	var returns interface{}
...
func (d *jsiiProxy_DataDatabricksAwsCrossaccountPolicy) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
