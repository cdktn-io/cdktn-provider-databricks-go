...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataDatabricksAwsCrossaccountPolicy)(nil)).Elem(),
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "passRoles", GoGetter: "PassRoles"},
			_jsii_.MemberProperty{JsiiProperty: "passRolesInput", GoGetter: "PassRolesInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetPassRoles", GoMethod: "ResetPassRoles"},
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*DataDatabricksAwsCrossaccountPolicyConfig)(nil)).Elem(),
	)
}
