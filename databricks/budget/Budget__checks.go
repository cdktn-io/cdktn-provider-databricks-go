...
func (b *jsiiProxy_Budget) validatePutAlertConfigurationsParameters(value interface{}) error {
	...
	case *[]*BudgetAlertConfigurations:
		value := value.(*[]*BudgetAlertConfigurations)
	...
	case []*BudgetAlertConfigurations:
		value_ := value.([]*BudgetAlertConfigurations)
		value := &value_
		for idx_cd4240, v := range *value {
			if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter value[%#v]", idx_cd4240) }); err != nil {
				return err
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktn.IResolvable, *[]*BudgetAlertConfigurations; received %#v (a %T)", value, value)
		}
	}
...
func (j *jsiiProxy_Budget) validateSetLifecycleParameters(val *cdktn.TerraformResourceLifecycle) error {
	if err := _jsii_.ValidateStruct(val, func() string { return "parameter val" }); err != nil {
		return err
	}
...
func (j *jsiiProxy_Budget) validateSetResourceTypeParameters(val *string) error {
	if val == nil {
		return fmt.Errorf("parameter val is required, but nil was provided")
	}
