...
func (j *jsiiProxy_Volume) validateSetCatalogNameParameters(val *string) error {
	return nil
}

func (j *jsiiProxy_Volume) validateSetCommentParameters(val *string) error {
	return nil
}
...
func (j *jsiiProxy_Volume) validateSetLifecycleParameters(val *cdktn.TerraformResourceLifecycle) error {
	return nil
}
...
func (j *jsiiProxy_Volume) validateSetOwnerParameters(val *string) error {
	return nil
}
...
func (j *jsiiProxy_Volume) validateSetSchemaNameParameters(val *string) error {
	return nil
}

func (j *jsiiProxy_Volume) validateSetStorageLocationParameters(val *string) error {
	return nil
}

func (j *jsiiProxy_Volume) validateSetVolumeTypeParameters(val *string) error {
	return nil
}
