...
// Represents a {@link https://registry.terraform.io/providers/databricks/databricks/1.125.0/docs/resources/volume databricks_volume}.
...
func (j *jsiiProxy_Volume) CatalogNameInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"catalogNameInput",
...
func (j *jsiiProxy_Volume) Comment() *string {
	var returns *string
	_jsii_.Get(
		j,
		"comment",
...
func (j *jsiiProxy_Volume) CommentInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"commentInput",
...
func (j *jsiiProxy_Volume) Owner() *string {
	var returns *string
	_jsii_.Get(
		j,
		"owner",
...
func (j *jsiiProxy_Volume) OwnerInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"ownerInput",
...
func (j *jsiiProxy_Volume) SchemaName() *string {
	var returns *string
	_jsii_.Get(
		j,
		"schemaName",
...
func (j *jsiiProxy_Volume) SchemaNameInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"schemaNameInput",
...
func (j *jsiiProxy_Volume) StorageLocation() *string {
	var returns *string
	_jsii_.Get(
		j,
		"storageLocation",
...
func (j *jsiiProxy_Volume) StorageLocationInput() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_Volume) VolumeTypeInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"volumeTypeInput",
...
// Create a new {@link https://registry.terraform.io/providers/databricks/databricks/1.125.0/docs/resources/volume databricks_volume} Resource.
...
func (j *jsiiProxy_Volume)SetCatalogName(val *string) {
...
func (j *jsiiProxy_Volume)SetComment(val *string) {
...
func (j *jsiiProxy_Volume)SetOwner(val *string) {
...
func (j *jsiiProxy_Volume)SetSchemaName(val *string) {
...
func (j *jsiiProxy_Volume)SetStorageLocation(val *string) {
...
func (j *jsiiProxy_Volume)SetVolumeType(val *string) {
...
func (v *jsiiProxy_Volume) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (v *jsiiProxy_Volume) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (v *jsiiProxy_Volume) ResetOwner() {
	_jsii_.InvokeVoid(
		v,
		"resetOwner",
		nil, // no parameters
...
func (v *jsiiProxy_Volume) ResetStorageLocation() {
	_jsii_.InvokeVoid(
		v,
		"resetStorageLocation",
		nil, // no parameters
