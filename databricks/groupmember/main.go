...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "memberIdInput", GoGetter: "MemberIdInput"},
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*GroupMemberProviderConfig)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktn/provider-databricks.groupMember.GroupMemberProviderConfigOutputReference",
		reflect.TypeOf((*GroupMemberProviderConfigOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
