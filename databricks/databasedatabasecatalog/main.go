...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DatabaseDatabaseCatalog)(nil)).Elem(),
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "createDatabaseIfNotExistsInput", GoGetter: "CreateDatabaseIfNotExistsInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetCreateDatabaseIfNotExists", GoMethod: "ResetCreateDatabaseIfNotExists"},
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*DatabaseDatabaseCatalogConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktn/provider-databricks.databaseDatabaseCatalog.DatabaseDatabaseCatalogProviderConfig",
		reflect.TypeOf((*DatabaseDatabaseCatalogProviderConfig)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktn/provider-databricks.databaseDatabaseCatalog.DatabaseDatabaseCatalogProviderConfigOutputReference",
		reflect.TypeOf((*DatabaseDatabaseCatalogProviderConfigOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
