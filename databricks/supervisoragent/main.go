...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*SupervisorAgent)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"@cdktn/provider-databricks.supervisorAgent.SupervisorAgentConfig",
		reflect.TypeOf((*SupervisorAgentConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktn/provider-databricks.supervisorAgent.SupervisorAgentProviderConfig",
		reflect.TypeOf((*SupervisorAgentProviderConfig)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktn/provider-databricks.supervisorAgent.SupervisorAgentProviderConfigOutputReference",
		reflect.TypeOf((*SupervisorAgentProviderConfigOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
