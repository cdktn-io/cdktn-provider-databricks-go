...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "initialBranchSpecInput", GoGetter: "InitialBranchSpecInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "putInitialBranchSpec", GoMethod: "PutInitialBranchSpec"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetInitialBranchSpec", GoMethod: "ResetInitialBranchSpec"},
	...
	_jsii_.RegisterStruct(
		"@cdktn/provider-databricks.postgresProject.PostgresProjectInitialBranchSpec",
		reflect.TypeOf((*PostgresProjectInitialBranchSpec)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktn/provider-databricks.postgresProject.PostgresProjectInitialBranchSpecOutputReference",
		reflect.TypeOf((*PostgresProjectInitialBranchSpecOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
