...
func (j *jsiiProxy_DataDatabricksAiGatewayModelProviderServicesModelProviderServicesConfigGeminiEnterpriseOutputReference) validateSetInternalValueParameters(val interface{}) error {
	...
	case cdktn.IResolvable:
		// ok
	case *DataDatabricksAiGatewayModelProviderServicesModelProviderServicesConfigGeminiEnterprise:
		val := val.(*DataDatabricksAiGatewayModelProviderServicesModelProviderServicesConfigGeminiEnterprise)
		if err := _jsii_.ValidateStruct(val, func() string { return "parameter val" }); err != nil {
			return err
		}
	case DataDatabricksAiGatewayModelProviderServicesModelProviderServicesConfigGeminiEnterprise:
		val_ := val.(DataDatabricksAiGatewayModelProviderServicesModelProviderServicesConfigGeminiEnterprise)
		val := &val_
		if err := _jsii_.ValidateStruct(val, func() string { return "parameter val" }); err != nil {
			return err
		}
	default:
		if !_jsii_.IsAnonymousProxy(val) {
			return fmt.Errorf("parameter val must be one of the allowed types: cdktn.IResolvable, *DataDatabricksAiGatewayModelProviderServicesModelProviderServicesConfigGeminiEnterprise; received %#v (a %T)", val, val)
		}
	}
