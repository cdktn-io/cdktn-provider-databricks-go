...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*CatalogWorkspaceBinding)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberMethod{JsiiMethod: "addMoveTarget", GoMethod: "AddMoveTarget"},
			_jsii_.MemberMethod{JsiiMethod: "addOverride", GoMethod: "AddOverride"},
			_jsii_.MemberProperty{JsiiProperty: "bindingType", GoGetter: "BindingType"},
			_jsii_.MemberProperty{JsiiProperty: "bindingTypeInput", GoGetter: "BindingTypeInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetBindingType", GoMethod: "ResetBindingType"},
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*CatalogWorkspaceBindingConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktn/provider-databricks.catalogWorkspaceBinding.CatalogWorkspaceBindingProviderConfig",
		reflect.TypeOf((*CatalogWorkspaceBindingProviderConfig)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktn/provider-databricks.catalogWorkspaceBinding.CatalogWorkspaceBindingProviderConfigOutputReference",
		reflect.TypeOf((*CatalogWorkspaceBindingProviderConfigOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
