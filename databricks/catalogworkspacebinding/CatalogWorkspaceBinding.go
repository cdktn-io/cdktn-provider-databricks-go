...
import (
	...
	"github.com/cdktn-io/cdktn-provider-databricks-go/databricks/v18/catalogworkspacebinding/internal"
	"github.com/open-constructs/cdk-terrain-go/cdktn"
)

// Represents a {@link https://registry.terraform.io/providers/databricks/databricks/1.128.0/docs/resources/catalog_workspace_binding databricks_catalog_workspace_binding}.
...
func (j *jsiiProxy_CatalogWorkspaceBinding) CatalogNameInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"catalogNameInput",
...
func (j *jsiiProxy_CatalogWorkspaceBinding) Connection() interface{} {
...
func (j *jsiiProxy_CatalogWorkspaceBinding) ConstructNodeMetadata() *map[string]interface{} {
...
func (j *jsiiProxy_CatalogWorkspaceBinding) Count() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"count",
...
func (j *jsiiProxy_CatalogWorkspaceBinding) DependsOn() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"dependsOn",
...
func (j *jsiiProxy_CatalogWorkspaceBinding) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_CatalogWorkspaceBinding) FriendlyUniqueId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"friendlyUniqueId",
...
func (j *jsiiProxy_CatalogWorkspaceBinding) Id() *string {
	var returns *string
	_jsii_.Get(
		j,
		"id",
...
func (j *jsiiProxy_CatalogWorkspaceBinding) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func (j *jsiiProxy_CatalogWorkspaceBinding) Node() constructs.Node {
...
func (j *jsiiProxy_CatalogWorkspaceBinding) Provisioners() *[]interface{} {
	var returns *[]interface{}
	_jsii_.Get(
		j,
		"provisioners",
...
func (j *jsiiProxy_CatalogWorkspaceBinding) RawOverrides() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"rawOverrides",
...
func (j *jsiiProxy_CatalogWorkspaceBinding) TerraformMetaArguments() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_CatalogWorkspaceBinding) TerraformResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
...
// Create a new {@link https://registry.terraform.io/providers/databricks/databricks/1.128.0/docs/resources/catalog_workspace_binding databricks_catalog_workspace_binding} Resource.
func NewCatalogWorkspaceBinding(scope constructs.Construct, id *string, config *CatalogWorkspaceBindingConfig) CatalogWorkspaceBinding {
	...
	if err := validateNewCatalogWorkspaceBindingParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_CatalogWorkspaceBinding)SetCatalogName(val *string) {
...
func (j *jsiiProxy_CatalogWorkspaceBinding)SetConnection(val interface{}) {
...
func (j *jsiiProxy_CatalogWorkspaceBinding)SetCount(val interface{}) {
...
func (j *jsiiProxy_CatalogWorkspaceBinding)SetDependsOn(val *[]*string) {
	_jsii_.Set(
		j,
		"dependsOn",
		val,
...
func (j *jsiiProxy_CatalogWorkspaceBinding)SetId(val *string) {
...
func (j *jsiiProxy_CatalogWorkspaceBinding)SetProvisioners(val *[]interface{}) {
...
func CatalogWorkspaceBinding_IsConstruct(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCatalogWorkspaceBinding_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func CatalogWorkspaceBinding_IsTerraformElement(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCatalogWorkspaceBinding_IsTerraformElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func CatalogWorkspaceBinding_IsTerraformResource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCatalogWorkspaceBinding_IsTerraformResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CatalogWorkspaceBinding_TfResourceType() *string {
	_init_.Initialize()
	var returns *string
	_jsii_.StaticGet(
		"@cdktn/provider-databricks.catalogWorkspaceBinding.CatalogWorkspaceBinding",
...
func (c *jsiiProxy_CatalogWorkspaceBinding) AddMoveTarget(moveTarget *string) {
...
func (c *jsiiProxy_CatalogWorkspaceBinding) AddOverride(path *string, value interface{}) {
...
func (c *jsiiProxy_CatalogWorkspaceBinding) GetAnyMapAttribute(terraformAttribute *string) *map[string]interface{} {
...
func (c *jsiiProxy_CatalogWorkspaceBinding) GetBooleanMapAttribute(terraformAttribute *string) *map[string]*bool {
...
func (c *jsiiProxy_CatalogWorkspaceBinding) GetListAttribute(terraformAttribute *string) *[]*string {
...
func (c *jsiiProxy_CatalogWorkspaceBinding) GetNumberAttribute(terraformAttribute *string) *float64 {
...
func (c *jsiiProxy_CatalogWorkspaceBinding) GetNumberListAttribute(terraformAttribute *string) *[]*float64 {
...
func (c *jsiiProxy_CatalogWorkspaceBinding) GetNumberMapAttribute(terraformAttribute *string) *map[string]*float64 {
...
func (c *jsiiProxy_CatalogWorkspaceBinding) GetStringAttribute(terraformAttribute *string) *string {
...
func (c *jsiiProxy_CatalogWorkspaceBinding) GetStringMapAttribute(terraformAttribute *string) *map[string]*string {
...
func (c *jsiiProxy_CatalogWorkspaceBinding) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (c *jsiiProxy_CatalogWorkspaceBinding) OverrideLogicalId(newLogicalId *string) {
...
func (c *jsiiProxy_CatalogWorkspaceBinding) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (c *jsiiProxy_CatalogWorkspaceBinding) ResetOverrideLogicalId() {
	_jsii_.InvokeVoid(
		c,
		"resetOverrideLogicalId",
		nil, // no parameters
...
func (c *jsiiProxy_CatalogWorkspaceBinding) SynthesizeAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (c *jsiiProxy_CatalogWorkspaceBinding) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (c *jsiiProxy_CatalogWorkspaceBinding) ToHclTerraform() interface{} {
	var returns interface{}
...
func (c *jsiiProxy_CatalogWorkspaceBinding) ToMetadata() interface{} {
	var returns interface{}
...
func (c *jsiiProxy_CatalogWorkspaceBinding) ToString() *string {
	var returns *string
...
func (c *jsiiProxy_CatalogWorkspaceBinding) ToTerraform() interface{} {
	var returns interface{}
...
func (c *jsiiProxy_CatalogWorkspaceBinding) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
