...
// Represents a {@link https://registry.terraform.io/providers/databricks/databricks/1.126.0/docs/resources/mlflow_experiment databricks_mlflow_experiment}.
type MlflowExperiment interface {
	...
	TraceLocation() MlflowExperimentTraceLocationOutputReference
	TraceLocationInput() *MlflowExperimentTraceLocation
	...
	PutTraceLocation(value *MlflowExperimentTraceLocation)
...
func (j *jsiiProxy_MlflowExperiment) TraceLocation() MlflowExperimentTraceLocationOutputReference {
	var returns MlflowExperimentTraceLocationOutputReference
	_jsii_.Get(
		j,
		"traceLocation",
		&returns,
...
func (j *jsiiProxy_MlflowExperiment) TraceLocationInput() *MlflowExperimentTraceLocation {
...
// Create a new {@link https://registry.terraform.io/providers/databricks/databricks/1.126.0/docs/resources/mlflow_experiment databricks_mlflow_experiment} Resource.
...
func (m *jsiiProxy_MlflowExperiment) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (m *jsiiProxy_MlflowExperiment) PutTraceLocation(value *MlflowExperimentTraceLocation) {
	if err := m.validatePutTraceLocationParameters(value); err != nil {
		panic(err)
	}
	_jsii_.InvokeVoid(
		m,
...
func (m *jsiiProxy_MlflowExperiment) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (m *jsiiProxy_MlflowExperiment) ResetTraceLocation() {
	_jsii_.InvokeVoid(
		m,
		"resetTraceLocation",
		nil, // no parameters
...
func (m *jsiiProxy_MlflowExperiment) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
