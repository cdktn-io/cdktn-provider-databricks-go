...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataDatabricksSqlWarehouses)(nil)).Elem(),
		[]_jsii_.Member{
			...
			_jsii_.MemberMethod{JsiiMethod: "resetWarehouseNameContains", GoMethod: "ResetWarehouseNameContains"},
			...
			_jsii_.MemberProperty{JsiiProperty: "warehouseNameContains", GoGetter: "WarehouseNameContains"},
			_jsii_.MemberProperty{JsiiProperty: "warehouseNameContainsInput", GoGetter: "WarehouseNameContainsInput"},
