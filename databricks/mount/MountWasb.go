...
type MountWasb struct {
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/databricks/databricks/1.115.0/docs/resources/mount#auth_type Mount#auth_type}.
	AuthType *string `field:"required" json:"authType" yaml:"authType"`
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/databricks/databricks/1.115.0/docs/resources/mount#token_secret_key Mount#token_secret_key}.
	TokenSecretKey *string `field:"required" json:"tokenSecretKey" yaml:"tokenSecretKey"`
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/databricks/databricks/1.115.0/docs/resources/mount#token_secret_scope Mount#token_secret_scope}.
