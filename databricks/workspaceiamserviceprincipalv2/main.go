...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*WorkspaceIamServicePrincipalV2)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberProperty{JsiiProperty: "accountId", GoGetter: "AccountId"},
			_jsii_.MemberProperty{JsiiProperty: "accountSpStatus", GoGetter: "AccountSpStatus"},
			_jsii_.MemberProperty{JsiiProperty: "accountSpStatusInput", GoGetter: "AccountSpStatusInput"},
	...
	_jsii_.RegisterStruct(
		"@cdktn/provider-databricks.workspaceIamServicePrincipalV2.WorkspaceIamServicePrincipalV2Config",
		reflect.TypeOf((*WorkspaceIamServicePrincipalV2Config)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktn/provider-databricks.workspaceIamServicePrincipalV2.WorkspaceIamServicePrincipalV2ProviderConfig",
		reflect.TypeOf((*WorkspaceIamServicePrincipalV2ProviderConfig)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktn/provider-databricks.workspaceIamServicePrincipalV2.WorkspaceIamServicePrincipalV2ProviderConfigOutputReference",
		reflect.TypeOf((*WorkspaceIamServicePrincipalV2ProviderConfigOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
