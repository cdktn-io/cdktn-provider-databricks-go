...
type QualityMonitorInferenceLog struct {
	...
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/databricks/databricks/1.130.0/docs/resources/quality_monitor#model_id_col QualityMonitor#model_id_col}.
	ModelIdCol *string `field:"required" json:"modelIdCol" yaml:"modelIdCol"`
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/databricks/databricks/1.130.0/docs/resources/quality_monitor#prediction_col QualityMonitor#prediction_col}.
	PredictionCol *string `field:"required" json:"predictionCol" yaml:"predictionCol"`
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/databricks/databricks/1.130.0/docs/resources/quality_monitor#problem_type QualityMonitor#problem_type}.
	...
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/databricks/databricks/1.130.0/docs/resources/quality_monitor#label_col QualityMonitor#label_col}.
	LabelCol *string `field:"optional" json:"labelCol" yaml:"labelCol"`
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/databricks/databricks/1.130.0/docs/resources/quality_monitor#prediction_proba_col QualityMonitor#prediction_proba_col}.
