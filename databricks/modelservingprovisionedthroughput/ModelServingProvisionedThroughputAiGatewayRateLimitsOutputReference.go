...
func (j *jsiiProxy_ModelServingProvisionedThroughputAiGatewayRateLimitsOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewModelServingProvisionedThroughputAiGatewayRateLimitsOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) ModelServingProvisionedThroughputAiGatewayRateLimitsOutputReference {
	_init_.Initialize()
...
func NewModelServingProvisionedThroughputAiGatewayRateLimitsOutputReference_Override(m ModelServingProvisionedThroughputAiGatewayRateLimitsOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_ModelServingProvisionedThroughputAiGatewayRateLimitsOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (m *jsiiProxy_ModelServingProvisionedThroughputAiGatewayRateLimitsOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (m *jsiiProxy_ModelServingProvisionedThroughputAiGatewayRateLimitsOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (m *jsiiProxy_ModelServingProvisionedThroughputAiGatewayRateLimitsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (m *jsiiProxy_ModelServingProvisionedThroughputAiGatewayRateLimitsOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
