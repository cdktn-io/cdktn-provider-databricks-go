...
func (m *jsiiProxy_ModelServingProvisionedThroughputAiGatewayRateLimitsList) validateResolveParameters(context cdktn.IResolveContext) error {
	if context == nil {
...
func (j *jsiiProxy_ModelServingProvisionedThroughputAiGatewayRateLimitsList) validateSetTerraformResourceParameters(val cdktn.IInterpolatingParent) error {
	if val == nil {
		return fmt.Errorf("parameter val is required, but nil was provided")
	}
...
func validateNewModelServingProvisionedThroughputAiGatewayRateLimitsListParameters(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) error {
