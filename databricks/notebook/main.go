...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*Notebook)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*NotebookConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktn/provider-databricks.notebook.NotebookProviderConfig",
		reflect.TypeOf((*NotebookProviderConfig)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktn/provider-databricks.notebook.NotebookProviderConfigOutputReference",
		reflect.TypeOf((*NotebookProviderConfigOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
