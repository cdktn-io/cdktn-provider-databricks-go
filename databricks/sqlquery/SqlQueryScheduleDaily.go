...
type SqlQueryScheduleDaily struct {
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/databricks/databricks/1.110.0/docs/resources/sql_query#interval_days SqlQuery#interval_days}.
