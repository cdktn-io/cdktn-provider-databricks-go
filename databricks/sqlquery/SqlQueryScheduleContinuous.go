...
type SqlQueryScheduleContinuous struct {
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/databricks/databricks/1.122.0/docs/resources/sql_query#interval_seconds SqlQuery#interval_seconds}.
