...
type SqlQueryParameterQuery struct {
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/databricks/databricks/1.113.0/docs/resources/sql_query#query_id SqlQuery#query_id}.
