...
// Represents a {@link https://registry.terraform.io/providers/databricks/databricks/1.126.0/docs/resources/aibi_dashboard_embedding_access_policy_setting databricks_aibi_dashboard_embedding_access_policy_setting}.
type AibiDashboardEmbeddingAccessPolicySetting interface {
	...
	ProviderConfig() AibiDashboardEmbeddingAccessPolicySettingProviderConfigOutputReference
	ProviderConfigInput() *AibiDashboardEmbeddingAccessPolicySettingProviderConfig
	// Experimental.
	...
	PutProviderConfig(value *AibiDashboardEmbeddingAccessPolicySettingProviderConfig)
...
func (j *jsiiProxy_AibiDashboardEmbeddingAccessPolicySetting) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_AibiDashboardEmbeddingAccessPolicySetting) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_AibiDashboardEmbeddingAccessPolicySetting) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_AibiDashboardEmbeddingAccessPolicySetting) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_AibiDashboardEmbeddingAccessPolicySetting) ProviderConfig() AibiDashboardEmbeddingAccessPolicySettingProviderConfigOutputReference {
	var returns AibiDashboardEmbeddingAccessPolicySettingProviderConfigOutputReference
	_jsii_.Get(
		j,
		"providerConfig",
		&returns,
...
func (j *jsiiProxy_AibiDashboardEmbeddingAccessPolicySetting) ProviderConfigInput() *AibiDashboardEmbeddingAccessPolicySettingProviderConfig {
...
func (j *jsiiProxy_AibiDashboardEmbeddingAccessPolicySetting) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/databricks/databricks/1.126.0/docs/resources/aibi_dashboard_embedding_access_policy_setting databricks_aibi_dashboard_embedding_access_policy_setting} Resource.
...
func (j *jsiiProxy_AibiDashboardEmbeddingAccessPolicySetting)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_AibiDashboardEmbeddingAccessPolicySetting)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_AibiDashboardEmbeddingAccessPolicySetting)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func AibiDashboardEmbeddingAccessPolicySetting_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (a *jsiiProxy_AibiDashboardEmbeddingAccessPolicySetting) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (a *jsiiProxy_AibiDashboardEmbeddingAccessPolicySetting) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (a *jsiiProxy_AibiDashboardEmbeddingAccessPolicySetting) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (a *jsiiProxy_AibiDashboardEmbeddingAccessPolicySetting) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (a *jsiiProxy_AibiDashboardEmbeddingAccessPolicySetting) PutProviderConfig(value *AibiDashboardEmbeddingAccessPolicySettingProviderConfig) {
...
func (a *jsiiProxy_AibiDashboardEmbeddingAccessPolicySetting) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (a *jsiiProxy_AibiDashboardEmbeddingAccessPolicySetting) ResetProviderConfig() {
	_jsii_.InvokeVoid(
		a,
		"resetProviderConfig",
		nil, // no parameters
...
func (a *jsiiProxy_AibiDashboardEmbeddingAccessPolicySetting) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
