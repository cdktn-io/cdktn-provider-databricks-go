...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*AibiDashboardEmbeddingAccessPolicySetting)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*AibiDashboardEmbeddingAccessPolicySettingAibiDashboardEmbeddingAccessPolicy)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*AibiDashboardEmbeddingAccessPolicySettingAibiDashboardEmbeddingAccessPolicyOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*AibiDashboardEmbeddingAccessPolicySettingConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*AibiDashboardEmbeddingAccessPolicySettingProviderConfig)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*AibiDashboardEmbeddingAccessPolicySettingProviderConfigOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIndex", GoGetter: "ComplexObjectIndex"},
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIsFromSet", GoGetter: "ComplexObjectIsFromSet"},
			_jsii_.MemberMethod{JsiiMethod: "computeFqn", GoMethod: "ComputeFqn"},
