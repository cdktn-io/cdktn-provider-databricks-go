...
// Represents a {@link https://registry.terraform.io/providers/databricks/databricks/1.125.0/docs/resources/alert_v2 databricks_alert_v2}.
type AlertV2 interface {
	...
	Parameters() AlertV2ParametersList
...
func (j *jsiiProxy_AlertV2) Parameters() AlertV2ParametersList {
	var returns AlertV2ParametersList
	_jsii_.Get(
		j,
		"parameters",
		&returns,
...
func (j *jsiiProxy_AlertV2) ParametersInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"parametersInput",
...
// Create a new {@link https://registry.terraform.io/providers/databricks/databricks/1.125.0/docs/resources/alert_v2 databricks_alert_v2} Resource.
...
func (a *jsiiProxy_AlertV2) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (a *jsiiProxy_AlertV2) PutParameters(value interface{}) {
...
func (a *jsiiProxy_AlertV2) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (a *jsiiProxy_AlertV2) ResetParameters() {
	_jsii_.InvokeVoid(
		a,
		"resetParameters",
		nil, // no parameters
