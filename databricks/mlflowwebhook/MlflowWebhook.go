...
// Represents a {@link https://registry.terraform.io/providers/databricks/databricks/1.129.0/docs/resources/mlflow_webhook databricks_mlflow_webhook}.
...
// Create a new {@link https://registry.terraform.io/providers/databricks/databricks/1.129.0/docs/resources/mlflow_webhook databricks_mlflow_webhook} Resource.
...
func (m *jsiiProxy_MlflowWebhook) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (m *jsiiProxy_MlflowWebhook) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (m *jsiiProxy_MlflowWebhook) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
