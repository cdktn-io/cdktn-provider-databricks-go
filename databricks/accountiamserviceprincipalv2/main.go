...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*AccountIamServicePrincipalV2)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"@cdktn/provider-databricks.accountIamServicePrincipalV2.AccountIamServicePrincipalV2Config",
		reflect.TypeOf((*AccountIamServicePrincipalV2Config)(nil)).Elem(),
	)
}
