...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "extraAttributes", GoGetter: "ExtraAttributes"},
			_jsii_.MemberProperty{JsiiProperty: "extraAttributesInput", GoGetter: "ExtraAttributesInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetExtraAttributes", GoMethod: "ResetExtraAttributes"},
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*DataDatabricksUsersProviderConfig)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktn/provider-databricks.dataDatabricksUsers.DataDatabricksUsersProviderConfigOutputReference",
		reflect.TypeOf((*DataDatabricksUsersProviderConfigOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberMethod{JsiiMethod: "putEntitlements", GoMethod: "PutEntitlements"},
