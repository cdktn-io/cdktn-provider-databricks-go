...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*GroupInstanceProfile)(nil)).Elem(),
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "instanceProfileId", GoGetter: "InstanceProfileId"},
			_jsii_.MemberProperty{JsiiProperty: "instanceProfileIdInput", GoGetter: "InstanceProfileIdInput"},
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*GroupInstanceProfileConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktn/provider-databricks.groupInstanceProfile.GroupInstanceProfileProviderConfig",
		reflect.TypeOf((*GroupInstanceProfileProviderConfig)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktn/provider-databricks.groupInstanceProfile.GroupInstanceProfileProviderConfigOutputReference",
		reflect.TypeOf((*GroupInstanceProfileProviderConfigOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
