...
func init() {
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*DataDatabricksDatabaseSyncedDatabaseTableProviderConfig)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataDatabricksDatabaseSyncedDatabaseTableProviderConfigOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIndex", GoGetter: "ComplexObjectIndex"},
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIsFromSet", GoGetter: "ComplexObjectIsFromSet"},
			_jsii_.MemberMethod{JsiiMethod: "computeFqn", GoMethod: "ComputeFqn"},
	...
	_jsii_.RegisterStruct(
		"@cdktn/provider-databricks.dataDatabricksDatabaseSyncedDatabaseTable.DataDatabricksDatabaseSyncedDatabaseTableSpecTypeOverrides",
		reflect.TypeOf((*DataDatabricksDatabaseSyncedDatabaseTableSpecTypeOverrides)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataDatabricksDatabaseSyncedDatabaseTableSpecTypeOverridesList)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataDatabricksDatabaseSyncedDatabaseTableSpecTypeOverridesOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
