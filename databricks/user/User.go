...
// Represents a {@link https://registry.terraform.io/providers/databricks/databricks/1.129.0/docs/resources/user databricks_user}.
type User interface {
...
// Create a new {@link https://registry.terraform.io/providers/databricks/databricks/1.129.0/docs/resources/user databricks_user} Resource.
...
func (u *jsiiProxy_User) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (u *jsiiProxy_User) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
