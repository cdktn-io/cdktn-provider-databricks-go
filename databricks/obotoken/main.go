...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*OboToken)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*OboTokenConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktn/provider-databricks.oboToken.OboTokenProviderConfig",
		reflect.TypeOf((*OboTokenProviderConfig)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktn/provider-databricks.oboToken.OboTokenProviderConfigOutputReference",
		reflect.TypeOf((*OboTokenProviderConfigOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
