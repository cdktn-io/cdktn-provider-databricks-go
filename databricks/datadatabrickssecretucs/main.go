...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataDatabricksSecretUcs)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"@cdktn/provider-databricks.dataDatabricksSecretUcs.DataDatabricksSecretUcsConfig",
		reflect.TypeOf((*DataDatabricksSecretUcsConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktn/provider-databricks.dataDatabricksSecretUcs.DataDatabricksSecretUcsProviderConfig",
		reflect.TypeOf((*DataDatabricksSecretUcsProviderConfig)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktn/provider-databricks.dataDatabricksSecretUcs.DataDatabricksSecretUcsProviderConfigOutputReference",
		reflect.TypeOf((*DataDatabricksSecretUcsProviderConfigOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"@cdktn/provider-databricks.dataDatabricksSecretUcs.DataDatabricksSecretUcsSecrets",
		reflect.TypeOf((*DataDatabricksSecretUcsSecrets)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktn/provider-databricks.dataDatabricksSecretUcs.DataDatabricksSecretUcsSecretsList",
		reflect.TypeOf((*DataDatabricksSecretUcsSecretsList)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataDatabricksSecretUcsSecretsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "effectiveValue", GoGetter: "EffectiveValue"},
			_jsii_.MemberProperty{JsiiProperty: "expireTime", GoGetter: "ExpireTime"},
			_jsii_.MemberProperty{JsiiProperty: "externalSecretId", GoGetter: "ExternalSecretId"},
			_jsii_.MemberProperty{JsiiProperty: "fqn", GoGetter: "Fqn"},
	...
	_jsii_.RegisterStruct(
		"@cdktn/provider-databricks.dataDatabricksSecretUcs.DataDatabricksSecretUcsSecretsProviderConfig",
		reflect.TypeOf((*DataDatabricksSecretUcsSecretsProviderConfig)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktn/provider-databricks.dataDatabricksSecretUcs.DataDatabricksSecretUcsSecretsProviderConfigOutputReference",
		reflect.TypeOf((*DataDatabricksSecretUcsSecretsProviderConfigOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIndex", GoGetter: "ComplexObjectIndex"},
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIsFromSet", GoGetter: "ComplexObjectIsFromSet"},
			_jsii_.MemberMethod{JsiiMethod: "computeFqn", GoMethod: "ComputeFqn"},
