...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*ArtifactAllowlist)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberMethod{JsiiMethod: "addMoveTarget", GoMethod: "AddMoveTarget"},
			_jsii_.MemberMethod{JsiiMethod: "addOverride", GoMethod: "AddOverride"},
			_jsii_.MemberProperty{JsiiProperty: "artifactMatcher", GoGetter: "ArtifactMatcher"},
			_jsii_.MemberProperty{JsiiProperty: "artifactMatcherInput", GoGetter: "ArtifactMatcherInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "putArtifactMatcher", GoMethod: "PutArtifactMatcher"},
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*ArtifactAllowlistArtifactMatcher)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktn/provider-databricks.artifactAllowlist.ArtifactAllowlistArtifactMatcherList",
		reflect.TypeOf((*ArtifactAllowlistArtifactMatcherList)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*ArtifactAllowlistArtifactMatcherOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberProperty{JsiiProperty: "artifact", GoGetter: "Artifact"},
			_jsii_.MemberProperty{JsiiProperty: "artifactInput", GoGetter: "ArtifactInput"},
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*ArtifactAllowlistConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktn/provider-databricks.artifactAllowlist.ArtifactAllowlistProviderConfig",
		reflect.TypeOf((*ArtifactAllowlistProviderConfig)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktn/provider-databricks.artifactAllowlist.ArtifactAllowlistProviderConfigOutputReference",
		reflect.TypeOf((*ArtifactAllowlistProviderConfigOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIndex", GoGetter: "ComplexObjectIndex"},
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIsFromSet", GoGetter: "ComplexObjectIsFromSet"},
			_jsii_.MemberMethod{JsiiMethod: "computeFqn", GoMethod: "ComputeFqn"},
