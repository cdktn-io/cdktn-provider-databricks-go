...
import (
	...
	"github.com/cdktn-io/cdktn-provider-databricks-go/databricks/v18/awss3mount/internal"
	"github.com/open-constructs/cdk-terrain-go/cdktn"
)

// Represents a {@link https://registry.terraform.io/providers/databricks/databricks/1.127.0/docs/resources/aws_s3_mount databricks_aws_s3_mount}.
...
func (j *jsiiProxy_AwsS3Mount) ClusterId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"clusterId",
...
func (j *jsiiProxy_AwsS3Mount) ClusterIdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"clusterIdInput",
...
func (j *jsiiProxy_AwsS3Mount) Connection() interface{} {
...
func (j *jsiiProxy_AwsS3Mount) ConstructNodeMetadata() *map[string]interface{} {
...
func (j *jsiiProxy_AwsS3Mount) DependsOn() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"dependsOn",
...
func (j *jsiiProxy_AwsS3Mount) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_AwsS3Mount) FriendlyUniqueId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"friendlyUniqueId",
...
func (j *jsiiProxy_AwsS3Mount) Id() *string {
	var returns *string
	_jsii_.Get(
		j,
		"id",
...
func (j *jsiiProxy_AwsS3Mount) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func (j *jsiiProxy_AwsS3Mount) InstanceProfile() *string {
	var returns *string
	_jsii_.Get(
		j,
		"instanceProfile",
...
func (j *jsiiProxy_AwsS3Mount) InstanceProfileInput() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_AwsS3Mount) MountName() *string {
	var returns *string
	_jsii_.Get(
		j,
		"mountName",
...
func (j *jsiiProxy_AwsS3Mount) MountNameInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"mountNameInput",
...
func (j *jsiiProxy_AwsS3Mount) Node() constructs.Node {
...
func (j *jsiiProxy_AwsS3Mount) Provisioners() *[]interface{} {
	var returns *[]interface{}
	_jsii_.Get(
		j,
		"provisioners",
...
func (j *jsiiProxy_AwsS3Mount) RawOverrides() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"rawOverrides",
...
func (j *jsiiProxy_AwsS3Mount) S3BucketName() *string {
	var returns *string
	_jsii_.Get(
		j,
		"s3BucketName",
...
func (j *jsiiProxy_AwsS3Mount) S3BucketNameInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"s3BucketNameInput",
...
func (j *jsiiProxy_AwsS3Mount) Source() *string {
	var returns *string
	_jsii_.Get(
		j,
		"source",
...
func (j *jsiiProxy_AwsS3Mount) TerraformMetaArguments() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_AwsS3Mount) TerraformResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
...
// Create a new {@link https://registry.terraform.io/providers/databricks/databricks/1.127.0/docs/resources/aws_s3_mount databricks_aws_s3_mount} Resource.
...
// Experimental.
func AwsS3Mount_IsTerraformElement(x interface{}) *bool {
	_init_.Initialize()

	if err := validateAwsS3Mount_IsTerraformElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func AwsS3Mount_IsTerraformResource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateAwsS3Mount_IsTerraformResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func AwsS3Mount_TfResourceType() *string {
	_init_.Initialize()
	var returns *string
	_jsii_.StaticGet(
		"@cdktn/provider-databricks.awsS3Mount.AwsS3Mount",
...
func (a *jsiiProxy_AwsS3Mount) AddMoveTarget(moveTarget *string) {
...
func (a *jsiiProxy_AwsS3Mount) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (a *jsiiProxy_AwsS3Mount) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (a *jsiiProxy_AwsS3Mount) ResetClusterId() {
	_jsii_.InvokeVoid(
		a,
		"resetClusterId",
		nil, // no parameters
...
func (a *jsiiProxy_AwsS3Mount) ResetId() {
	_jsii_.InvokeVoid(
		a,
		"resetId",
		nil, // no parameters
...
func (a *jsiiProxy_AwsS3Mount) ResetInstanceProfile() {
	_jsii_.InvokeVoid(
		a,
		"resetInstanceProfile",
		nil, // no parameters
...
func (a *jsiiProxy_AwsS3Mount) ResetOverrideLogicalId() {
	_jsii_.InvokeVoid(
		a,
		"resetOverrideLogicalId",
		nil, // no parameters
...
func (a *jsiiProxy_AwsS3Mount) SynthesizeAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (a *jsiiProxy_AwsS3Mount) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (a *jsiiProxy_AwsS3Mount) ToHclTerraform() interface{} {
	var returns interface{}
...
func (a *jsiiProxy_AwsS3Mount) ToMetadata() interface{} {
	var returns interface{}
...
func (a *jsiiProxy_AwsS3Mount) ToString() *string {
	var returns *string
...
func (a *jsiiProxy_AwsS3Mount) ToTerraform() interface{} {
	var returns interface{}
