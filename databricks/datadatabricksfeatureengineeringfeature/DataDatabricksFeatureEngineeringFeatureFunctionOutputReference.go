...
type DataDatabricksFeatureEngineeringFeatureFunctionOutputReference interface {
	...
	ColumnSelection() DataDatabricksFeatureEngineeringFeatureFunctionColumnSelectionOutputReference
...
func (j *jsiiProxy_DataDatabricksFeatureEngineeringFeatureFunctionOutputReference) ColumnSelection() DataDatabricksFeatureEngineeringFeatureFunctionColumnSelectionOutputReference {
	var returns DataDatabricksFeatureEngineeringFeatureFunctionColumnSelectionOutputReference
	_jsii_.Get(
		j,
		"columnSelection",
		&returns,
...
func (j *jsiiProxy_DataDatabricksFeatureEngineeringFeatureFunctionOutputReference) ColumnSelectionInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_DataDatabricksFeatureEngineeringFeatureFunctionOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataDatabricksFeatureEngineeringFeatureFunctionOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) DataDatabricksFeatureEngineeringFeatureFunctionOutputReference {
	_init_.Initialize()
...
func NewDataDatabricksFeatureEngineeringFeatureFunctionOutputReference_Override(d DataDatabricksFeatureEngineeringFeatureFunctionOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataDatabricksFeatureEngineeringFeatureFunctionOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataDatabricksFeatureEngineeringFeatureFunctionOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataDatabricksFeatureEngineeringFeatureFunctionOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (d *jsiiProxy_DataDatabricksFeatureEngineeringFeatureFunctionOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataDatabricksFeatureEngineeringFeatureFunctionOutputReference) PutColumnSelection(value *DataDatabricksFeatureEngineeringFeatureFunctionColumnSelection) {
...
func (d *jsiiProxy_DataDatabricksFeatureEngineeringFeatureFunctionOutputReference) ResetColumnSelection() {
	_jsii_.InvokeVoid(
		d,
		"resetColumnSelection",
		nil, // no parameters
...
func (d *jsiiProxy_DataDatabricksFeatureEngineeringFeatureFunctionOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
