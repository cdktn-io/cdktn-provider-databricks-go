...
func (j *jsiiProxy_DataDatabricksFeatureEngineeringFeatureTimeWindowOutputReference) StartTime() *string {
	var returns *string
	_jsii_.Get(
		j,
		"startTime",
...
func (j *jsiiProxy_DataDatabricksFeatureEngineeringFeatureTimeWindowOutputReference) StartTimeInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"startTimeInput",
...
func (j *jsiiProxy_DataDatabricksFeatureEngineeringFeatureTimeWindowOutputReference)SetStartTime(val *string) {
...
func (d *jsiiProxy_DataDatabricksFeatureEngineeringFeatureTimeWindowOutputReference) ResetStartTime() {
	_jsii_.InvokeVoid(
		d,
		"resetStartTime",
		nil, // no parameters
