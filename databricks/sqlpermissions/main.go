...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "anonymousFunction", GoGetter: "AnonymousFunction"},
			_jsii_.MemberProperty{JsiiProperty: "anonymousFunctionInput", GoGetter: "AnonymousFunctionInput"},
			_jsii_.MemberProperty{JsiiProperty: "anyFile", GoGetter: "AnyFile"},
			_jsii_.MemberProperty{JsiiProperty: "anyFileInput", GoGetter: "AnyFileInput"},
			...
			_jsii_.MemberProperty{JsiiProperty: "privilegeAssignments", GoGetter: "PrivilegeAssignments"},
			_jsii_.MemberProperty{JsiiProperty: "privilegeAssignmentsInput", GoGetter: "PrivilegeAssignmentsInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "putPrivilegeAssignments", GoMethod: "PutPrivilegeAssignments"},
			_jsii_.MemberMethod{JsiiMethod: "putProviderConfig", GoMethod: "PutProviderConfig"},
			_jsii_.MemberProperty{JsiiProperty: "rawOverrides", GoGetter: "RawOverrides"},
			_jsii_.MemberMethod{JsiiMethod: "resetAnonymousFunction", GoMethod: "ResetAnonymousFunction"},
			_jsii_.MemberMethod{JsiiMethod: "resetAnyFile", GoMethod: "ResetAnyFile"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetPrivilegeAssignments", GoMethod: "ResetPrivilegeAssignments"},
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*SqlPermissionsProviderConfig)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktn/provider-databricks.sqlPermissions.SqlPermissionsProviderConfigOutputReference",
		reflect.TypeOf((*SqlPermissionsProviderConfigOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIndex", GoGetter: "ComplexObjectIndex"},
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIsFromSet", GoGetter: "ComplexObjectIsFromSet"},
			_jsii_.MemberMethod{JsiiMethod: "computeFqn", GoMethod: "ComputeFqn"},
