...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*EntityTagAssignment)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*EntityTagAssignmentConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktn/provider-databricks.entityTagAssignment.EntityTagAssignmentProviderConfig",
		reflect.TypeOf((*EntityTagAssignmentProviderConfig)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktn/provider-databricks.entityTagAssignment.EntityTagAssignmentProviderConfigOutputReference",
		reflect.TypeOf((*EntityTagAssignmentProviderConfigOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
