...
func (j *jsiiProxy_FeatureEngineeringFeatureTimeWindowTumblingOutputReference) Delay() *string {
	var returns *string
	_jsii_.Get(
		j,
		"delay",
...
func (j *jsiiProxy_FeatureEngineeringFeatureTimeWindowTumblingOutputReference) DelayInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"delayInput",
...
func (j *jsiiProxy_FeatureEngineeringFeatureTimeWindowTumblingOutputReference) Offset() *string {
	var returns *string
	_jsii_.Get(
		j,
		"offset",
...
func (j *jsiiProxy_FeatureEngineeringFeatureTimeWindowTumblingOutputReference) OffsetInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"offsetInput",
...
func (j *jsiiProxy_FeatureEngineeringFeatureTimeWindowTumblingOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewFeatureEngineeringFeatureTimeWindowTumblingOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) FeatureEngineeringFeatureTimeWindowTumblingOutputReference {
	_init_.Initialize()
...
func NewFeatureEngineeringFeatureTimeWindowTumblingOutputReference_Override(f FeatureEngineeringFeatureTimeWindowTumblingOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_FeatureEngineeringFeatureTimeWindowTumblingOutputReference)SetDelay(val *string) {
...
func (j *jsiiProxy_FeatureEngineeringFeatureTimeWindowTumblingOutputReference)SetOffset(val *string) {
...
func (j *jsiiProxy_FeatureEngineeringFeatureTimeWindowTumblingOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (f *jsiiProxy_FeatureEngineeringFeatureTimeWindowTumblingOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (f *jsiiProxy_FeatureEngineeringFeatureTimeWindowTumblingOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (f *jsiiProxy_FeatureEngineeringFeatureTimeWindowTumblingOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (f *jsiiProxy_FeatureEngineeringFeatureTimeWindowTumblingOutputReference) ResetDelay() {
	_jsii_.InvokeVoid(
		f,
		"resetDelay",
		nil, // no parameters
...
func (f *jsiiProxy_FeatureEngineeringFeatureTimeWindowTumblingOutputReference) ResetOffset() {
	_jsii_.InvokeVoid(
		f,
		"resetOffset",
		nil, // no parameters
...
func (f *jsiiProxy_FeatureEngineeringFeatureTimeWindowTumblingOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
