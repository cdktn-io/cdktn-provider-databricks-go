...
func (j *jsiiProxy_FeatureEngineeringFeatureTimeWindowContinuousOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewFeatureEngineeringFeatureTimeWindowContinuousOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) FeatureEngineeringFeatureTimeWindowContinuousOutputReference {
	_init_.Initialize()
...
func NewFeatureEngineeringFeatureTimeWindowContinuousOutputReference_Override(f FeatureEngineeringFeatureTimeWindowContinuousOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_FeatureEngineeringFeatureTimeWindowContinuousOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (f *jsiiProxy_FeatureEngineeringFeatureTimeWindowContinuousOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (f *jsiiProxy_FeatureEngineeringFeatureTimeWindowContinuousOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (f *jsiiProxy_FeatureEngineeringFeatureTimeWindowContinuousOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (f *jsiiProxy_FeatureEngineeringFeatureTimeWindowContinuousOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
