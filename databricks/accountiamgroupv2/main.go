...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*AccountIamGroupV2)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"@cdktn/provider-databricks.accountIamGroupV2.AccountIamGroupV2Config",
		reflect.TypeOf((*AccountIamGroupV2Config)(nil)).Elem(),
	)
}
