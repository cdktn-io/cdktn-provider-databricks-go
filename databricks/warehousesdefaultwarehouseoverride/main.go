...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*WarehousesDefaultWarehouseOverride)(nil)).Elem(),
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "defaultWarehouseOverrideIdInput", GoGetter: "DefaultWarehouseOverrideIdInput"},
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*WarehousesDefaultWarehouseOverrideConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktn/provider-databricks.warehousesDefaultWarehouseOverride.WarehousesDefaultWarehouseOverrideProviderConfig",
		reflect.TypeOf((*WarehousesDefaultWarehouseOverrideProviderConfig)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*WarehousesDefaultWarehouseOverrideProviderConfigOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
