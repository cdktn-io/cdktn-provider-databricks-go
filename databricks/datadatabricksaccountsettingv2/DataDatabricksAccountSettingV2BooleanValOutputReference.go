...
func (j *jsiiProxy_DataDatabricksAccountSettingV2BooleanValOutputReference) ComplexObjectIsFromSet() *bool {
	var returns *bool
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_DataDatabricksAccountSettingV2BooleanValOutputReference) CreationStack() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"creationStack",
...
func (j *jsiiProxy_DataDatabricksAccountSettingV2BooleanValOutputReference) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_DataDatabricksAccountSettingV2BooleanValOutputReference) TerraformAttribute() *string {
	var returns *string
	_jsii_.Get(
		j,
		"terraformAttribute",
...
func (j *jsiiProxy_DataDatabricksAccountSettingV2BooleanValOutputReference) Value() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"value",
...
func (j *jsiiProxy_DataDatabricksAccountSettingV2BooleanValOutputReference) ValueInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"valueInput",
...
func (j *jsiiProxy_DataDatabricksAccountSettingV2BooleanValOutputReference)SetComplexObjectIndex(val interface{}) {
...
func (j *jsiiProxy_DataDatabricksAccountSettingV2BooleanValOutputReference)SetComplexObjectIsFromSet(val *bool) {
...
func (j *jsiiProxy_DataDatabricksAccountSettingV2BooleanValOutputReference)SetTerraformAttribute(val *string) {
...
func (j *jsiiProxy_DataDatabricksAccountSettingV2BooleanValOutputReference)SetValue(val interface{}) {
...
func (d *jsiiProxy_DataDatabricksAccountSettingV2BooleanValOutputReference) ComputeFqn() *string {
	var returns *string
...
func (d *jsiiProxy_DataDatabricksAccountSettingV2BooleanValOutputReference) GetAnyMapAttribute(terraformAttribute *string) *map[string]interface{} {
...
func (d *jsiiProxy_DataDatabricksAccountSettingV2BooleanValOutputReference) GetBooleanMapAttribute(terraformAttribute *string) *map[string]*bool {
...
func (d *jsiiProxy_DataDatabricksAccountSettingV2BooleanValOutputReference) GetListAttribute(terraformAttribute *string) *[]*string {
...
func (d *jsiiProxy_DataDatabricksAccountSettingV2BooleanValOutputReference) GetNumberAttribute(terraformAttribute *string) *float64 {
...
func (d *jsiiProxy_DataDatabricksAccountSettingV2BooleanValOutputReference) GetNumberListAttribute(terraformAttribute *string) *[]*float64 {
...
func (d *jsiiProxy_DataDatabricksAccountSettingV2BooleanValOutputReference) GetNumberMapAttribute(terraformAttribute *string) *map[string]*float64 {
...
func (d *jsiiProxy_DataDatabricksAccountSettingV2BooleanValOutputReference) GetStringAttribute(terraformAttribute *string) *string {
...
func (d *jsiiProxy_DataDatabricksAccountSettingV2BooleanValOutputReference) GetStringMapAttribute(terraformAttribute *string) *map[string]*string {
...
func (d *jsiiProxy_DataDatabricksAccountSettingV2BooleanValOutputReference) ResetValue() {
	_jsii_.InvokeVoid(
		d,
		"resetValue",
		nil, // no parameters
...
func (d *jsiiProxy_DataDatabricksAccountSettingV2BooleanValOutputReference) ToString() *string {
	var returns *string
