...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*GlobalInitScript)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*GlobalInitScriptConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktn/provider-databricks.globalInitScript.GlobalInitScriptProviderConfig",
		reflect.TypeOf((*GlobalInitScriptProviderConfig)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktn/provider-databricks.globalInitScript.GlobalInitScriptProviderConfigOutputReference",
		reflect.TypeOf((*GlobalInitScriptProviderConfigOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*GlobalInitScriptTimeouts)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktn/provider-databricks.globalInitScript.GlobalInitScriptTimeoutsOutputReference",
		reflect.TypeOf((*GlobalInitScriptTimeoutsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIndex", GoGetter: "ComplexObjectIndex"},
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIsFromSet", GoGetter: "ComplexObjectIsFromSet"},
			_jsii_.MemberMethod{JsiiMethod: "computeFqn", GoMethod: "ComputeFqn"},
