...
// Represents a {@link https://registry.terraform.io/providers/databricks/databricks/1.128.0/docs/resources/global_init_script databricks_global_init_script}.
...
func (j *jsiiProxy_GlobalInitScript) Connection() interface{} {
...
func (j *jsiiProxy_GlobalInitScript) ConstructNodeMetadata() *map[string]interface{} {
...
func (j *jsiiProxy_GlobalInitScript) ContentBase64() *string {
	var returns *string
	_jsii_.Get(
		j,
		"contentBase64",
...
func (j *jsiiProxy_GlobalInitScript) ContentBase64Input() *string {
	var returns *string
	_jsii_.Get(
		j,
		"contentBase64Input",
...
func (j *jsiiProxy_GlobalInitScript) Count() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"count",
...
func (j *jsiiProxy_GlobalInitScript) DependsOn() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"dependsOn",
...
func (j *jsiiProxy_GlobalInitScript) Enabled() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"enabled",
...
func (j *jsiiProxy_GlobalInitScript) EnabledInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"enabledInput",
...
func (j *jsiiProxy_GlobalInitScript) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_GlobalInitScript) FriendlyUniqueId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"friendlyUniqueId",
...
func (j *jsiiProxy_GlobalInitScript) Id() *string {
	var returns *string
	_jsii_.Get(
		j,
		"id",
...
func (j *jsiiProxy_GlobalInitScript) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func (j *jsiiProxy_GlobalInitScript) Md5() *string {
	var returns *string
	_jsii_.Get(
		j,
		"md5",
...
func (j *jsiiProxy_GlobalInitScript) Md5Input() *string {
	var returns *string
	_jsii_.Get(
		j,
		"md5Input",
...
func (j *jsiiProxy_GlobalInitScript) Name() *string {
	var returns *string
	_jsii_.Get(
		j,
		"name",
...
func (j *jsiiProxy_GlobalInitScript) NameInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"nameInput",
...
func (j *jsiiProxy_GlobalInitScript) Node() constructs.Node {
...
func (j *jsiiProxy_GlobalInitScript) Position() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
		"position",
...
func (j *jsiiProxy_GlobalInitScript) PositionInput() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
		"positionInput",
...
func (j *jsiiProxy_GlobalInitScript) Provisioners() *[]interface{} {
	var returns *[]interface{}
	_jsii_.Get(
		j,
		"provisioners",
...
func (j *jsiiProxy_GlobalInitScript) RawOverrides() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"rawOverrides",
...
func (j *jsiiProxy_GlobalInitScript) Source() *string {
	var returns *string
	_jsii_.Get(
		j,
		"source",
...
func (j *jsiiProxy_GlobalInitScript) SourceInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"sourceInput",
...
func (j *jsiiProxy_GlobalInitScript) TerraformMetaArguments() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_GlobalInitScript) TerraformResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_GlobalInitScript) Timeouts() GlobalInitScriptTimeoutsOutputReference {
	var returns GlobalInitScriptTimeoutsOutputReference
	_jsii_.Get(
		j,
		"timeouts",
		&returns,
...
func (j *jsiiProxy_GlobalInitScript) TimeoutsInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"timeoutsInput",
...
// Create a new {@link https://registry.terraform.io/providers/databricks/databricks/1.128.0/docs/resources/global_init_script databricks_global_init_script} Resource.
...
func (j *jsiiProxy_GlobalInitScript)SetCount(val interface{}) {
...
// Experimental.
func GlobalInitScript_IsTerraformElement(x interface{}) *bool {
	_init_.Initialize()

	if err := validateGlobalInitScript_IsTerraformElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func GlobalInitScript_IsTerraformResource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateGlobalInitScript_IsTerraformResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func GlobalInitScript_TfResourceType() *string {
	_init_.Initialize()
	var returns *string
	_jsii_.StaticGet(
		"@cdktn/provider-databricks.globalInitScript.GlobalInitScript",
...
func (g *jsiiProxy_GlobalInitScript) AddMoveTarget(moveTarget *string) {
...
func (g *jsiiProxy_GlobalInitScript) HasResourceMove() interface{} {
	var returns interface{}
...
func (g *jsiiProxy_GlobalInitScript) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (g *jsiiProxy_GlobalInitScript) MoveFromId(id *string) {
...
func (g *jsiiProxy_GlobalInitScript) MoveTo(moveTarget *string, index interface{}) {
...
func (g *jsiiProxy_GlobalInitScript) MoveToId(id *string) {
...
func (g *jsiiProxy_GlobalInitScript) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (g *jsiiProxy_GlobalInitScript) ResetContentBase64() {
	_jsii_.InvokeVoid(
		g,
		"resetContentBase64",
		nil, // no parameters
...
func (g *jsiiProxy_GlobalInitScript) ResetEnabled() {
	_jsii_.InvokeVoid(
		g,
		"resetEnabled",
		nil, // no parameters
...
func (g *jsiiProxy_GlobalInitScript) ResetId() {
	_jsii_.InvokeVoid(
		g,
		"resetId",
		nil, // no parameters
...
func (g *jsiiProxy_GlobalInitScript) ResetMd5() {
	_jsii_.InvokeVoid(
		g,
		"resetMd5",
		nil, // no parameters
...
func (g *jsiiProxy_GlobalInitScript) ResetOverrideLogicalId() {
	_jsii_.InvokeVoid(
		g,
		"resetOverrideLogicalId",
		nil, // no parameters
...
func (g *jsiiProxy_GlobalInitScript) ResetPosition() {
	_jsii_.InvokeVoid(
		g,
		"resetPosition",
		nil, // no parameters
...
func (g *jsiiProxy_GlobalInitScript) ResetSource() {
	_jsii_.InvokeVoid(
		g,
		"resetSource",
		nil, // no parameters
...
func (g *jsiiProxy_GlobalInitScript) SynthesizeAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (g *jsiiProxy_GlobalInitScript) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (g *jsiiProxy_GlobalInitScript) ToHclTerraform() interface{} {
	var returns interface{}
...
func (g *jsiiProxy_GlobalInitScript) ToMetadata() interface{} {
	var returns interface{}
...
func (g *jsiiProxy_GlobalInitScript) ToString() *string {
	var returns *string
...
func (g *jsiiProxy_GlobalInitScript) ToTerraform() interface{} {
	var returns interface{}
...
func (g *jsiiProxy_GlobalInitScript) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
