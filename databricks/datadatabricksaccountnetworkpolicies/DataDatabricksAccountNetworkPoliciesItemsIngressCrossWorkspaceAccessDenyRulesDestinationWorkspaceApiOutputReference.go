...
func (j *jsiiProxy_DataDatabricksAccountNetworkPoliciesItemsIngressCrossWorkspaceAccessDenyRulesDestinationWorkspaceApiOutputReference) ExcludedScopes() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"excludedScopes",
...
func (j *jsiiProxy_DataDatabricksAccountNetworkPoliciesItemsIngressCrossWorkspaceAccessDenyRulesDestinationWorkspaceApiOutputReference) ExcludedScopesInput() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"excludedScopesInput",
...
func (j *jsiiProxy_DataDatabricksAccountNetworkPoliciesItemsIngressCrossWorkspaceAccessDenyRulesDestinationWorkspaceApiOutputReference)SetExcludedScopes(val *[]*string) {
...
func (d *jsiiProxy_DataDatabricksAccountNetworkPoliciesItemsIngressCrossWorkspaceAccessDenyRulesDestinationWorkspaceApiOutputReference) ResetExcludedScopes() {
	_jsii_.InvokeVoid(
		d,
		"resetExcludedScopes",
		nil, // no parameters
