...
func (j *jsiiProxy_DataDatabricksClusterPluginframeworkClusterInfoSpecAutoscaleList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataDatabricksClusterPluginframeworkClusterInfoSpecAutoscaleList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataDatabricksClusterPluginframeworkClusterInfoSpecAutoscaleList {
	_init_.Initialize()
...
func NewDataDatabricksClusterPluginframeworkClusterInfoSpecAutoscaleList_Override(d DataDatabricksClusterPluginframeworkClusterInfoSpecAutoscaleList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataDatabricksClusterPluginframeworkClusterInfoSpecAutoscaleList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataDatabricksClusterPluginframeworkClusterInfoSpecAutoscaleList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataDatabricksClusterPluginframeworkClusterInfoSpecAutoscaleList) Resolve(context cdktn.IResolveContext) interface{} {
