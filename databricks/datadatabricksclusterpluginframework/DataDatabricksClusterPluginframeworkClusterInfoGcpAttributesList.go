...
func (j *jsiiProxy_DataDatabricksClusterPluginframeworkClusterInfoGcpAttributesList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataDatabricksClusterPluginframeworkClusterInfoGcpAttributesList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataDatabricksClusterPluginframeworkClusterInfoGcpAttributesList {
	_init_.Initialize()
...
func NewDataDatabricksClusterPluginframeworkClusterInfoGcpAttributesList_Override(d DataDatabricksClusterPluginframeworkClusterInfoGcpAttributesList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataDatabricksClusterPluginframeworkClusterInfoGcpAttributesList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataDatabricksClusterPluginframeworkClusterInfoGcpAttributesList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataDatabricksClusterPluginframeworkClusterInfoGcpAttributesList) Resolve(context cdktn.IResolveContext) interface{} {
