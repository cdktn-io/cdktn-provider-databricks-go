...
func (d *jsiiProxy_DataDatabricksClusterPluginframeworkClusterInfoClusterLogConfS3List) validateResolveParameters(context cdktn.IResolveContext) error {
	if context == nil {
...
func (j *jsiiProxy_DataDatabricksClusterPluginframeworkClusterInfoClusterLogConfS3List) validateSetTerraformResourceParameters(val cdktn.IInterpolatingParent) error {
	if val == nil {
		return fmt.Errorf("parameter val is required, but nil was provided")
	}
...
func validateNewDataDatabricksClusterPluginframeworkClusterInfoClusterLogConfS3ListParameters(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) error {
