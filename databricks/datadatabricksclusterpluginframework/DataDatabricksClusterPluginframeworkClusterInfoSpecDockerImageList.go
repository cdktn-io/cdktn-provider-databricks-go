...
func (j *jsiiProxy_DataDatabricksClusterPluginframeworkClusterInfoSpecDockerImageList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataDatabricksClusterPluginframeworkClusterInfoSpecDockerImageList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataDatabricksClusterPluginframeworkClusterInfoSpecDockerImageList {
	_init_.Initialize()
...
func NewDataDatabricksClusterPluginframeworkClusterInfoSpecDockerImageList_Override(d DataDatabricksClusterPluginframeworkClusterInfoSpecDockerImageList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataDatabricksClusterPluginframeworkClusterInfoSpecDockerImageList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataDatabricksClusterPluginframeworkClusterInfoSpecDockerImageList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataDatabricksClusterPluginframeworkClusterInfoSpecDockerImageList) Resolve(context cdktn.IResolveContext) interface{} {
