...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "configReference", GoGetter: "ConfigReference"},
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*SecretProviderConfig)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktn/provider-databricks.secret.SecretProviderConfigOutputReference",
		reflect.TypeOf((*SecretProviderConfigOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
