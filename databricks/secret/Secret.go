...
// Represents a {@link https://registry.terraform.io/providers/databricks/databricks/1.130.0/docs/resources/secret databricks_secret}.
...
func (j *jsiiProxy_Secret) Connection() interface{} {
...
func (j *jsiiProxy_Secret) Count() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"count",
...
func (j *jsiiProxy_Secret) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func (j *jsiiProxy_Secret) Key() *string {
	var returns *string
	_jsii_.Get(
		j,
		"key",
...
func (j *jsiiProxy_Secret) KeyInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"keyInput",
...
func (j *jsiiProxy_Secret) LastUpdatedTimestamp() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_Secret) Provisioners() *[]interface{} {
	var returns *[]interface{}
	_jsii_.Get(
		j,
		"provisioners",
...
func (j *jsiiProxy_Secret) Scope() *string {
	var returns *string
	_jsii_.Get(
		j,
		"scope",
...
func (j *jsiiProxy_Secret) ScopeInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"scopeInput",
...
func (j *jsiiProxy_Secret) StringValue() *string {
	var returns *string
	_jsii_.Get(
		j,
		"stringValue",
...
func (j *jsiiProxy_Secret) StringValueInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"stringValueInput",
...
func (j *jsiiProxy_Secret) TerraformMetaArguments() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_Secret) TerraformResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
...
// Create a new {@link https://registry.terraform.io/providers/databricks/databricks/1.130.0/docs/resources/secret databricks_secret} Resource.
...
func (j *jsiiProxy_Secret)SetConnection(val interface{}) {
...
func (j *jsiiProxy_Secret)SetCount(val interface{}) {
...
func (j *jsiiProxy_Secret)SetKey(val *string) {
...
func (j *jsiiProxy_Secret)SetProvisioners(val *[]interface{}) {
...
func (j *jsiiProxy_Secret)SetScope(val *string) {
...
func (j *jsiiProxy_Secret)SetStringValue(val *string) {
...
// Experimental.
func Secret_IsTerraformResource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateSecret_IsTerraformResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (s *jsiiProxy_Secret) AddMoveTarget(moveTarget *string) {
...
func (s *jsiiProxy_Secret) GetAnyMapAttribute(terraformAttribute *string) *map[string]interface{} {
...
func (s *jsiiProxy_Secret) GetBooleanMapAttribute(terraformAttribute *string) *map[string]*bool {
...
func (s *jsiiProxy_Secret) GetListAttribute(terraformAttribute *string) *[]*string {
...
func (s *jsiiProxy_Secret) GetNumberAttribute(terraformAttribute *string) *float64 {
...
func (s *jsiiProxy_Secret) GetNumberListAttribute(terraformAttribute *string) *[]*float64 {
...
func (s *jsiiProxy_Secret) GetNumberMapAttribute(terraformAttribute *string) *map[string]*float64 {
...
func (s *jsiiProxy_Secret) GetStringAttribute(terraformAttribute *string) *string {
...
func (s *jsiiProxy_Secret) GetStringMapAttribute(terraformAttribute *string) *map[string]*string {
...
func (s *jsiiProxy_Secret) HasResourceMove() interface{} {
	var returns interface{}
...
func (s *jsiiProxy_Secret) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (s *jsiiProxy_Secret) MoveFromId(id *string) {
...
func (s *jsiiProxy_Secret) MoveTo(moveTarget *string, index interface{}) {
...
func (s *jsiiProxy_Secret) MoveToId(id *string) {
...
func (s *jsiiProxy_Secret) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
