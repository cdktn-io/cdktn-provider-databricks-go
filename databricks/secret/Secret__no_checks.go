...
func (s *jsiiProxy_Secret) validatePutProviderConfigParameters(value *SecretProviderConfig) error {
	return nil
}
...
func (j *jsiiProxy_Secret) validateSetKeyParameters(val *string) error {
	return nil
}
...
func (j *jsiiProxy_Secret) validateSetScopeParameters(val *string) error {
	return nil
}

func (j *jsiiProxy_Secret) validateSetStringValueParameters(val *string) error {
	return nil
}
