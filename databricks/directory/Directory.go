...
// Represents a {@link https://registry.terraform.io/providers/databricks/databricks/1.126.0/docs/resources/directory databricks_directory}.
...
func (j *jsiiProxy_Directory) Connection() interface{} {
...
func (j *jsiiProxy_Directory) ConstructNodeMetadata() *map[string]interface{} {
...
func (j *jsiiProxy_Directory) Count() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"count",
...
func (j *jsiiProxy_Directory) DeleteRecursive() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"deleteRecursive",
...
func (j *jsiiProxy_Directory) DeleteRecursiveInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_Directory) DependsOn() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"dependsOn",
...
func (j *jsiiProxy_Directory) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_Directory) FriendlyUniqueId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"friendlyUniqueId",
...
func (j *jsiiProxy_Directory) Id() *string {
	var returns *string
	_jsii_.Get(
		j,
		"id",
...
func (j *jsiiProxy_Directory) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func (j *jsiiProxy_Directory) Node() constructs.Node {
...
func (j *jsiiProxy_Directory) ObjectId() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
		"objectId",
...
func (j *jsiiProxy_Directory) ObjectIdInput() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
		"objectIdInput",
...
func (j *jsiiProxy_Directory) Path() *string {
	var returns *string
	_jsii_.Get(
		j,
		"path",
...
func (j *jsiiProxy_Directory) PathInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"pathInput",
...
func (j *jsiiProxy_Directory) Provisioners() *[]interface{} {
	var returns *[]interface{}
	_jsii_.Get(
		j,
		"provisioners",
...
func (j *jsiiProxy_Directory) RawOverrides() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"rawOverrides",
...
func (j *jsiiProxy_Directory) TerraformMetaArguments() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_Directory) TerraformResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
...
// Create a new {@link https://registry.terraform.io/providers/databricks/databricks/1.126.0/docs/resources/directory databricks_directory} Resource.
...
func (j *jsiiProxy_Directory)SetCount(val interface{}) {
...
// Experimental.
func Directory_IsTerraformElement(x interface{}) *bool {
	_init_.Initialize()

	if err := validateDirectory_IsTerraformElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func Directory_IsTerraformResource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateDirectory_IsTerraformResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func Directory_TfResourceType() *string {
	_init_.Initialize()
	var returns *string
	_jsii_.StaticGet(
		"@cdktn/provider-databricks.directory.Directory",
...
func (d *jsiiProxy_Directory) AddMoveTarget(moveTarget *string) {
...
func (d *jsiiProxy_Directory) HasResourceMove() interface{} {
	var returns interface{}
...
func (d *jsiiProxy_Directory) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (d *jsiiProxy_Directory) MoveFromId(id *string) {
...
func (d *jsiiProxy_Directory) MoveTo(moveTarget *string, index interface{}) {
...
func (d *jsiiProxy_Directory) MoveToId(id *string) {
...
func (d *jsiiProxy_Directory) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (d *jsiiProxy_Directory) ResetId() {
	_jsii_.InvokeVoid(
		d,
		"resetId",
		nil, // no parameters
...
func (d *jsiiProxy_Directory) ResetObjectId() {
	_jsii_.InvokeVoid(
		d,
		"resetObjectId",
		nil, // no parameters
...
func (d *jsiiProxy_Directory) ResetOverrideLogicalId() {
	_jsii_.InvokeVoid(
		d,
		"resetOverrideLogicalId",
		nil, // no parameters
...
func (d *jsiiProxy_Directory) SynthesizeAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (d *jsiiProxy_Directory) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (d *jsiiProxy_Directory) ToHclTerraform() interface{} {
	var returns interface{}
...
func (d *jsiiProxy_Directory) ToMetadata() interface{} {
	var returns interface{}
...
func (d *jsiiProxy_Directory) ToString() *string {
	var returns *string
...
func (d *jsiiProxy_Directory) ToTerraform() interface{} {
	var returns interface{}
...
func (d *jsiiProxy_Directory) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
