...
func (j *jsiiProxy_JobTaskList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewJobTaskList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) JobTaskList {
	_init_.Initialize()

	if err := validateNewJobTaskListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
...
func NewJobTaskList_Override(j JobTaskList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_JobTaskList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (j *jsiiProxy_JobTaskList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (j *jsiiProxy_JobTaskList) Resolve(context cdktn.IResolveContext) interface{} {
