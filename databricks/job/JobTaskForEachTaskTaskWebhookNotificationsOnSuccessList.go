...
func (j *jsiiProxy_JobTaskForEachTaskTaskWebhookNotificationsOnSuccessList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewJobTaskForEachTaskTaskWebhookNotificationsOnSuccessList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) JobTaskForEachTaskTaskWebhookNotificationsOnSuccessList {
	_init_.Initialize()
...
func NewJobTaskForEachTaskTaskWebhookNotificationsOnSuccessList_Override(j JobTaskForEachTaskTaskWebhookNotificationsOnSuccessList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_JobTaskForEachTaskTaskWebhookNotificationsOnSuccessList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (j *jsiiProxy_JobTaskForEachTaskTaskWebhookNotificationsOnSuccessList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (j *jsiiProxy_JobTaskForEachTaskTaskWebhookNotificationsOnSuccessList) Resolve(context cdktn.IResolveContext) interface{} {
