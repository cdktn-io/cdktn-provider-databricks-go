...
func (j *jsiiProxy_JobTaskLibraryOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewJobTaskLibraryOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) JobTaskLibraryOutputReference {
	_init_.Initialize()
...
func NewJobTaskLibraryOutputReference_Override(j JobTaskLibraryOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_JobTaskLibraryOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (j *jsiiProxy_JobTaskLibraryOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (j *jsiiProxy_JobTaskLibraryOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (j *jsiiProxy_JobTaskLibraryOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (j *jsiiProxy_JobTaskLibraryOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
