...
func (j *jsiiProxy_JobTaskForEachTaskTaskNewClusterGcpAttributesOutputReference) ConfidentialComputeType() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_JobTaskForEachTaskTaskNewClusterGcpAttributesOutputReference) ConfidentialComputeTypeInput() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_JobTaskForEachTaskTaskNewClusterGcpAttributesOutputReference)SetConfidentialComputeType(val *string) {
...
func (j *jsiiProxy_JobTaskForEachTaskTaskNewClusterGcpAttributesOutputReference) ResetConfidentialComputeType() {
	_jsii_.InvokeVoid(
		j,
		"resetConfidentialComputeType",
		nil, // no parameters
