...
func (j *jsiiProxy_JobTaskForEachTaskTaskPowerBiTaskTablesOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewJobTaskForEachTaskTaskPowerBiTaskTablesOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) JobTaskForEachTaskTaskPowerBiTaskTablesOutputReference {
	_init_.Initialize()
...
func NewJobTaskForEachTaskTaskPowerBiTaskTablesOutputReference_Override(j JobTaskForEachTaskTaskPowerBiTaskTablesOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_JobTaskForEachTaskTaskPowerBiTaskTablesOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (j *jsiiProxy_JobTaskForEachTaskTaskPowerBiTaskTablesOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (j *jsiiProxy_JobTaskForEachTaskTaskPowerBiTaskTablesOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (j *jsiiProxy_JobTaskForEachTaskTaskPowerBiTaskTablesOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (j *jsiiProxy_JobTaskForEachTaskTaskPowerBiTaskTablesOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
