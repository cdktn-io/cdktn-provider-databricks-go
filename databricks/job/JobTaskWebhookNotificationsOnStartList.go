...
func (j *jsiiProxy_JobTaskWebhookNotificationsOnStartList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewJobTaskWebhookNotificationsOnStartList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) JobTaskWebhookNotificationsOnStartList {
	_init_.Initialize()
...
func NewJobTaskWebhookNotificationsOnStartList_Override(j JobTaskWebhookNotificationsOnStartList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_JobTaskWebhookNotificationsOnStartList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (j *jsiiProxy_JobTaskWebhookNotificationsOnStartList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (j *jsiiProxy_JobTaskWebhookNotificationsOnStartList) Resolve(context cdktn.IResolveContext) interface{} {
