...
func (j *jsiiProxy_JobWebhookNotificationsOnSuccessList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewJobWebhookNotificationsOnSuccessList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) JobWebhookNotificationsOnSuccessList {
	_init_.Initialize()
...
func NewJobWebhookNotificationsOnSuccessList_Override(j JobWebhookNotificationsOnSuccessList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_JobWebhookNotificationsOnSuccessList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (j *jsiiProxy_JobWebhookNotificationsOnSuccessList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (j *jsiiProxy_JobWebhookNotificationsOnSuccessList) Resolve(context cdktn.IResolveContext) interface{} {
