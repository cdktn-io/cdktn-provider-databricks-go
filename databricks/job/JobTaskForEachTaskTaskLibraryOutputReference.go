...
type JobTaskForEachTaskTaskLibraryOutputReference interface {
	...
	ProviderConfig() JobTaskForEachTaskTaskLibraryProviderConfigOutputReference
	ProviderConfigInput() *JobTaskForEachTaskTaskLibraryProviderConfig
	...
	PutProviderConfig(value *JobTaskForEachTaskTaskLibraryProviderConfig)
...
func (j *jsiiProxy_JobTaskForEachTaskTaskLibraryOutputReference) ProviderConfig() JobTaskForEachTaskTaskLibraryProviderConfigOutputReference {
	var returns JobTaskForEachTaskTaskLibraryProviderConfigOutputReference
	_jsii_.Get(
		j,
		"providerConfig",
		&returns,
...
func (j *jsiiProxy_JobTaskForEachTaskTaskLibraryOutputReference) ProviderConfigInput() *JobTaskForEachTaskTaskLibraryProviderConfig {
...
func (j *jsiiProxy_JobTaskForEachTaskTaskLibraryOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewJobTaskForEachTaskTaskLibraryOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) JobTaskForEachTaskTaskLibraryOutputReference {
	_init_.Initialize()
...
func NewJobTaskForEachTaskTaskLibraryOutputReference_Override(j JobTaskForEachTaskTaskLibraryOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_JobTaskForEachTaskTaskLibraryOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (j *jsiiProxy_JobTaskForEachTaskTaskLibraryOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (j *jsiiProxy_JobTaskForEachTaskTaskLibraryOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (j *jsiiProxy_JobTaskForEachTaskTaskLibraryOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (j *jsiiProxy_JobTaskForEachTaskTaskLibraryOutputReference) PutProviderConfig(value *JobTaskForEachTaskTaskLibraryProviderConfig) {
...
func (j *jsiiProxy_JobTaskForEachTaskTaskLibraryOutputReference) ResetProviderConfig() {
	_jsii_.InvokeVoid(
		j,
		"resetProviderConfig",
		nil, // no parameters
...
func (j *jsiiProxy_JobTaskForEachTaskTaskLibraryOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
