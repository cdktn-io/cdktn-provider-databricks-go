...
func (j *jsiiProxy_JobTaskWebhookNotificationsOnSuccessList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewJobTaskWebhookNotificationsOnSuccessList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) JobTaskWebhookNotificationsOnSuccessList {
	_init_.Initialize()
...
func NewJobTaskWebhookNotificationsOnSuccessList_Override(j JobTaskWebhookNotificationsOnSuccessList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_JobTaskWebhookNotificationsOnSuccessList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (j *jsiiProxy_JobTaskWebhookNotificationsOnSuccessList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (j *jsiiProxy_JobTaskWebhookNotificationsOnSuccessList) Resolve(context cdktn.IResolveContext) interface{} {
