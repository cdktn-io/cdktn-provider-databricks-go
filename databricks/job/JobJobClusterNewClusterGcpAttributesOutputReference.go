...
func (j *jsiiProxy_JobJobClusterNewClusterGcpAttributesOutputReference) ConfidentialComputeType() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_JobJobClusterNewClusterGcpAttributesOutputReference) ConfidentialComputeTypeInput() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_JobJobClusterNewClusterGcpAttributesOutputReference)SetConfidentialComputeType(val *string) {
...
func (j *jsiiProxy_JobJobClusterNewClusterGcpAttributesOutputReference) ResetConfidentialComputeType() {
	_jsii_.InvokeVoid(
		j,
		"resetConfidentialComputeType",
		nil, // no parameters
