...
func (j *jsiiProxy_JobTaskSparkJarTaskOutputReference) RunAsRepl() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"runAsRepl",
...
func (j *jsiiProxy_JobTaskSparkJarTaskOutputReference) RunAsReplInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"runAsReplInput",
...
func (j *jsiiProxy_JobTaskSparkJarTaskOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewJobTaskSparkJarTaskOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) JobTaskSparkJarTaskOutputReference {
	_init_.Initialize()
...
func NewJobTaskSparkJarTaskOutputReference_Override(j JobTaskSparkJarTaskOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_JobTaskSparkJarTaskOutputReference)SetRunAsRepl(val interface{}) {
...
func (j *jsiiProxy_JobTaskSparkJarTaskOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (j *jsiiProxy_JobTaskSparkJarTaskOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (j *jsiiProxy_JobTaskSparkJarTaskOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (j *jsiiProxy_JobTaskSparkJarTaskOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (j *jsiiProxy_JobTaskSparkJarTaskOutputReference) ResetRunAsRepl() {
	_jsii_.InvokeVoid(
		j,
		"resetRunAsRepl",
		nil, // no parameters
...
func (j *jsiiProxy_JobTaskSparkJarTaskOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
