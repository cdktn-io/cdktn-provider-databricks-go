...
func (j *jsiiProxy_JobNewClusterInitScriptsS3OutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewJobNewClusterInitScriptsS3OutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) JobNewClusterInitScriptsS3OutputReference {
	_init_.Initialize()

	if err := validateNewJobNewClusterInitScriptsS3OutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
...
func NewJobNewClusterInitScriptsS3OutputReference_Override(j JobNewClusterInitScriptsS3OutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_JobNewClusterInitScriptsS3OutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (j *jsiiProxy_JobNewClusterInitScriptsS3OutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (j *jsiiProxy_JobNewClusterInitScriptsS3OutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (j *jsiiProxy_JobNewClusterInitScriptsS3OutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (j *jsiiProxy_JobNewClusterInitScriptsS3OutputReference) Resolve(context cdktn.IResolveContext) interface{} {
