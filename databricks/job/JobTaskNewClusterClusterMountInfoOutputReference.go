...
func (j *jsiiProxy_JobTaskNewClusterClusterMountInfoOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewJobTaskNewClusterClusterMountInfoOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) JobTaskNewClusterClusterMountInfoOutputReference {
	_init_.Initialize()
...
func NewJobTaskNewClusterClusterMountInfoOutputReference_Override(j JobTaskNewClusterClusterMountInfoOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_JobTaskNewClusterClusterMountInfoOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (j *jsiiProxy_JobTaskNewClusterClusterMountInfoOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (j *jsiiProxy_JobTaskNewClusterClusterMountInfoOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (j *jsiiProxy_JobTaskNewClusterClusterMountInfoOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (j *jsiiProxy_JobTaskNewClusterClusterMountInfoOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
