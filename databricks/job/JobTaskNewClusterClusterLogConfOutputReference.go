...
type JobTaskNewClusterClusterLogConfOutputReference interface {
	...
	Volumes() JobTaskNewClusterClusterLogConfVolumesOutputReference
	VolumesInput() *JobTaskNewClusterClusterLogConfVolumes
	// Experimental.
	ComputeFqn() *string
	// Experimental.
	...
	PutVolumes(value *JobTaskNewClusterClusterLogConfVolumes)
	ResetDbfs()
	ResetS3()
	ResetVolumes()
...
func (j *jsiiProxy_JobTaskNewClusterClusterLogConfOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func (j *jsiiProxy_JobTaskNewClusterClusterLogConfOutputReference) Volumes() JobTaskNewClusterClusterLogConfVolumesOutputReference {
	var returns JobTaskNewClusterClusterLogConfVolumesOutputReference
	_jsii_.Get(
		j,
		"volumes",
		&returns,
...
func (j *jsiiProxy_JobTaskNewClusterClusterLogConfOutputReference) VolumesInput() *JobTaskNewClusterClusterLogConfVolumes {
...
func NewJobTaskNewClusterClusterLogConfOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) JobTaskNewClusterClusterLogConfOutputReference {
	_init_.Initialize()

	if err := validateNewJobTaskNewClusterClusterLogConfOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
...
func NewJobTaskNewClusterClusterLogConfOutputReference_Override(j JobTaskNewClusterClusterLogConfOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_JobTaskNewClusterClusterLogConfOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (j *jsiiProxy_JobTaskNewClusterClusterLogConfOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (j *jsiiProxy_JobTaskNewClusterClusterLogConfOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (j *jsiiProxy_JobTaskNewClusterClusterLogConfOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (j *jsiiProxy_JobTaskNewClusterClusterLogConfOutputReference) PutVolumes(value *JobTaskNewClusterClusterLogConfVolumes) {
...
func (j *jsiiProxy_JobTaskNewClusterClusterLogConfOutputReference) ResetVolumes() {
	_jsii_.InvokeVoid(
		j,
		"resetVolumes",
		nil, // no parameters
...
func (j *jsiiProxy_JobTaskNewClusterClusterLogConfOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
