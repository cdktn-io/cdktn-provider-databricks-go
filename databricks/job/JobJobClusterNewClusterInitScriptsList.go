...
func (j *jsiiProxy_JobJobClusterNewClusterInitScriptsList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewJobJobClusterNewClusterInitScriptsList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) JobJobClusterNewClusterInitScriptsList {
	_init_.Initialize()
...
func NewJobJobClusterNewClusterInitScriptsList_Override(j JobJobClusterNewClusterInitScriptsList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_JobJobClusterNewClusterInitScriptsList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (j *jsiiProxy_JobJobClusterNewClusterInitScriptsList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (j *jsiiProxy_JobJobClusterNewClusterInitScriptsList) Resolve(context cdktn.IResolveContext) interface{} {
