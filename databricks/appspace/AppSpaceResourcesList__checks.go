...
func (j *jsiiProxy_AppSpaceResourcesList) validateSetInternalValueParameters(val interface{}) error {
	...
	default:
		if !_jsii_.IsAnonymousProxy(val) {
			return fmt.Errorf("parameter val must be one of the allowed types: cdktn.IResolvable, *[]*AppSpaceResources; received %#v (a %T)", val, val)
		}
	}
