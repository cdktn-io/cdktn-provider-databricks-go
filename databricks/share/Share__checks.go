...
func (s *jsiiProxy_Share) validateMarkWriteOnlyAttributeParameters(value interface{}) error {
	if value == nil {
		return fmt.Errorf("parameter value is required, but nil was provided")
	}
...
func (s *jsiiProxy_Share) validatePutObjectParameters(value interface{}) error {
	if value == nil {
		return fmt.Errorf("parameter value is required, but nil was provided")
	}
	switch value.(type) {
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktn.IResolvable, *[]*ShareObject; received %#v (a %T)", value, value)
		}
	}
...
func (s *jsiiProxy_Share) validatePutProviderConfigParameters(value interface{}) error {
	...
	case cdktn.IResolvable:
		// ok
	case *[]*ShareProviderConfig:
		value := value.(*[]*ShareProviderConfig)
		for idx_cd4240, v := range *value {
			if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter value[%#v]", idx_cd4240) }); err != nil {
				return err
			}
	...
	case []*ShareProviderConfig:
		value_ := value.([]*ShareProviderConfig)
		value := &value_
		for idx_cd4240, v := range *value {
			if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter value[%#v]", idx_cd4240) }); err != nil {
				return err
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktn.IResolvable, *[]*ShareProviderConfig; received %#v (a %T)", value, value)
		}
	}
...
func (s *jsiiProxy_Share) validateRegisterProviderFeatureUsageParameters(feature cdktn.ProviderFeature) error {
	if feature == "" {
...
func (j *jsiiProxy_Share) validateSetOwnerParameters(val *string) error {
	if val == nil {
		return fmt.Errorf("parameter val is required, but nil was provided")
	}
