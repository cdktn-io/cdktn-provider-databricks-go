...
func (j *jsiiProxy_DataDatabricksClusterClusterInfoGcpAttributesOutputReference) ConfidentialComputeType() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_DataDatabricksClusterClusterInfoGcpAttributesOutputReference) ConfidentialComputeTypeInput() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_DataDatabricksClusterClusterInfoGcpAttributesOutputReference)SetConfidentialComputeType(val *string) {
...
func (d *jsiiProxy_DataDatabricksClusterClusterInfoGcpAttributesOutputReference) ResetConfidentialComputeType() {
	_jsii_.InvokeVoid(
		d,
		"resetConfidentialComputeType",
		nil, // no parameters
