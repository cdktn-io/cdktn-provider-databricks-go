...
func (j *jsiiProxy_DataDatabricksClusterClusterInfoSpecWorkerNodeTypeFlexibilityOutputReference) AwsContextId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"awsContextId",
...
func (j *jsiiProxy_DataDatabricksClusterClusterInfoSpecWorkerNodeTypeFlexibilityOutputReference) AwsContextIdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"awsContextIdInput",
...
func (j *jsiiProxy_DataDatabricksClusterClusterInfoSpecWorkerNodeTypeFlexibilityOutputReference)SetAwsContextId(val *string) {
...
func (d *jsiiProxy_DataDatabricksClusterClusterInfoSpecWorkerNodeTypeFlexibilityOutputReference) ResetAwsContextId() {
	_jsii_.InvokeVoid(
		d,
		"resetAwsContextId",
		nil, // no parameters
