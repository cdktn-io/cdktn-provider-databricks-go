...
func (j *jsiiProxy_DataDatabricksClusterClusterInfoSpecGcpAttributesOutputReference) ConfidentialComputeType() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_DataDatabricksClusterClusterInfoSpecGcpAttributesOutputReference) ConfidentialComputeTypeInput() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_DataDatabricksClusterClusterInfoSpecGcpAttributesOutputReference)SetConfidentialComputeType(val *string) {
...
func (d *jsiiProxy_DataDatabricksClusterClusterInfoSpecGcpAttributesOutputReference) ResetConfidentialComputeType() {
	_jsii_.InvokeVoid(
		d,
		"resetConfidentialComputeType",
		nil, // no parameters
