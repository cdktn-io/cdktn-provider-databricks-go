...
type DataDatabricksClusterClusterInfoSpecInitScripts struct {
	// abfss block.
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/databricks/databricks/1.113.0/docs/data-sources/cluster#abfss DataDatabricksCluster#abfss}
	...
	// file block.
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/databricks/databricks/1.113.0/docs/data-sources/cluster#file DataDatabricksCluster#file}
	File *DataDatabricksClusterClusterInfoSpecInitScriptsFile `field:"optional" json:"file" yaml:"file"`
	// gcs block.
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/databricks/databricks/1.113.0/docs/data-sources/cluster#gcs DataDatabricksCluster#gcs}
	...
	// workspace block.
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/databricks/databricks/1.113.0/docs/data-sources/cluster#workspace DataDatabricksCluster#workspace}
