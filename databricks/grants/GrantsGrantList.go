...
func (j *jsiiProxy_GrantsGrantList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewGrantsGrantList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) GrantsGrantList {
	_init_.Initialize()

	if err := validateNewGrantsGrantListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
...
func NewGrantsGrantList_Override(g GrantsGrantList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_GrantsGrantList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (g *jsiiProxy_GrantsGrantList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (g *jsiiProxy_GrantsGrantList) Resolve(context cdktn.IResolveContext) interface{} {
