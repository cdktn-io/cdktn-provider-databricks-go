...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "mcpService", GoGetter: "McpService"},
			_jsii_.MemberProperty{JsiiProperty: "mcpServiceInput", GoGetter: "McpServiceInput"},
			...
			_jsii_.MemberProperty{JsiiProperty: "modelService", GoGetter: "ModelService"},
			_jsii_.MemberProperty{JsiiProperty: "modelServiceInput", GoGetter: "ModelServiceInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetMcpService", GoMethod: "ResetMcpService"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetModelProviderService", GoMethod: "ResetModelProviderService"},
			_jsii_.MemberMethod{JsiiMethod: "resetModelService", GoMethod: "ResetModelService"},
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*GrantsConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktn/provider-databricks.grants.GrantsGrant",
		reflect.TypeOf((*GrantsGrant)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktn/provider-databricks.grants.GrantsGrantList",
		reflect.TypeOf((*GrantsGrantList)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*GrantsGrantOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*GrantsProviderConfig)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktn/provider-databricks.grants.GrantsProviderConfigOutputReference",
		reflect.TypeOf((*GrantsProviderConfigOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIndex", GoGetter: "ComplexObjectIndex"},
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIsFromSet", GoGetter: "ComplexObjectIsFromSet"},
			_jsii_.MemberMethod{JsiiMethod: "computeFqn", GoMethod: "ComputeFqn"},
