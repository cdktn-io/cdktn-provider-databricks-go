...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataDatabricksSecretUc)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"@cdktn/provider-databricks.dataDatabricksSecretUc.DataDatabricksSecretUcConfig",
		reflect.TypeOf((*DataDatabricksSecretUcConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktn/provider-databricks.dataDatabricksSecretUc.DataDatabricksSecretUcProviderConfig",
		reflect.TypeOf((*DataDatabricksSecretUcProviderConfig)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktn/provider-databricks.dataDatabricksSecretUc.DataDatabricksSecretUcProviderConfigOutputReference",
		reflect.TypeOf((*DataDatabricksSecretUcProviderConfigOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
