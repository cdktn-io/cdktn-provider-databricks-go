...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*MetastoreAssignment)(nil)).Elem(),
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "defaultCatalogName", GoGetter: "DefaultCatalogName"},
			_jsii_.MemberProperty{JsiiProperty: "defaultCatalogNameInput", GoGetter: "DefaultCatalogNameInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetDefaultCatalogName", GoMethod: "ResetDefaultCatalogName"},
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*MetastoreAssignmentConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktn/provider-databricks.metastoreAssignment.MetastoreAssignmentProviderConfig",
		reflect.TypeOf((*MetastoreAssignmentProviderConfig)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktn/provider-databricks.metastoreAssignment.MetastoreAssignmentProviderConfigOutputReference",
		reflect.TypeOf((*MetastoreAssignmentProviderConfigOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
