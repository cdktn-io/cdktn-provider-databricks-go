...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "commitHashInput", GoGetter: "CommitHashInput"},
			...
			_jsii_.MemberProperty{JsiiProperty: "gitCredentialId", GoGetter: "GitCredentialId"},
			_jsii_.MemberProperty{JsiiProperty: "gitCredentialIdInput", GoGetter: "GitCredentialIdInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetCommitHash", GoMethod: "ResetCommitHash"},
			_jsii_.MemberMethod{JsiiMethod: "resetGitCredentialId", GoMethod: "ResetGitCredentialId"},
			_jsii_.MemberMethod{JsiiMethod: "resetGitProvider", GoMethod: "ResetGitProvider"},
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*RepoConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktn/provider-databricks.repo.RepoProviderConfig",
		reflect.TypeOf((*RepoProviderConfig)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktn/provider-databricks.repo.RepoProviderConfigOutputReference",
		reflect.TypeOf((*RepoProviderConfigOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*RepoSparseCheckout)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktn/provider-databricks.repo.RepoSparseCheckoutOutputReference",
		reflect.TypeOf((*RepoSparseCheckoutOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIndex", GoGetter: "ComplexObjectIndex"},
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIsFromSet", GoGetter: "ComplexObjectIsFromSet"},
			_jsii_.MemberMethod{JsiiMethod: "computeFqn", GoMethod: "ComputeFqn"},
