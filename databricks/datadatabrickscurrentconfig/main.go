...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataDatabricksCurrentConfig)(nil)).Elem(),
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "isAccount", GoGetter: "IsAccount"},
			_jsii_.MemberProperty{JsiiProperty: "isAccountInput", GoGetter: "IsAccountInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetIsAccount", GoMethod: "ResetIsAccount"},
