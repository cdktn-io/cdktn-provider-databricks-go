...
func (j *jsiiProxy_DataDatabricksNotebookPathsNotebookPathListStructList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataDatabricksNotebookPathsNotebookPathListStructList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataDatabricksNotebookPathsNotebookPathListStructList {
	_init_.Initialize()
...
func NewDataDatabricksNotebookPathsNotebookPathListStructList_Override(d DataDatabricksNotebookPathsNotebookPathListStructList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataDatabricksNotebookPathsNotebookPathListStructList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataDatabricksNotebookPathsNotebookPathListStructList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataDatabricksNotebookPathsNotebookPathListStructList) Resolve(context cdktn.IResolveContext) interface{} {
