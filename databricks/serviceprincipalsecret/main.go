...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*ServicePrincipalSecret)(nil)).Elem(),
		[]_jsii_.Member{
			...
			_jsii_.MemberMethod{JsiiMethod: "resetSecretHash", GoMethod: "ResetSecretHash"},
			_jsii_.MemberMethod{JsiiMethod: "resetStatus", GoMethod: "ResetStatus"},
			_jsii_.MemberMethod{JsiiMethod: "resetTimeRotating", GoMethod: "ResetTimeRotating"},
			...
			_jsii_.MemberProperty{JsiiProperty: "secretHash", GoGetter: "SecretHash"},
			_jsii_.MemberProperty{JsiiProperty: "secretHashInput", GoGetter: "SecretHashInput"},
			...
			_jsii_.MemberProperty{JsiiProperty: "timeRotating", GoGetter: "TimeRotating"},
			_jsii_.MemberProperty{JsiiProperty: "timeRotatingInput", GoGetter: "TimeRotatingInput"},
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*ServicePrincipalSecretConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktn/provider-databricks.servicePrincipalSecret.ServicePrincipalSecretProviderConfig",
		reflect.TypeOf((*ServicePrincipalSecretProviderConfig)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktn/provider-databricks.servicePrincipalSecret.ServicePrincipalSecretProviderConfigOutputReference",
		reflect.TypeOf((*ServicePrincipalSecretProviderConfigOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
