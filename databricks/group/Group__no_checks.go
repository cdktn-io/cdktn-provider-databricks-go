...
func (j *jsiiProxy_Group) validateSetDatabricksSqlAccessParameters(val interface{}) error {
	return nil
}

func (j *jsiiProxy_Group) validateSetDisplayNameParameters(val *string) error {
	return nil
}

func (j *jsiiProxy_Group) validateSetExternalIdParameters(val *string) error {
	return nil
}

func (j *jsiiProxy_Group) validateSetForceParameters(val interface{}) error {
	return nil
}
...
func (j *jsiiProxy_Group) validateSetUrlParameters(val *string) error {
	return nil
}

func (j *jsiiProxy_Group) validateSetWorkspaceAccessParameters(val interface{}) error {
	return nil
}
