...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "forLogDelivery", GoGetter: "ForLogDelivery"},
			_jsii_.MemberProperty{JsiiProperty: "forLogDeliveryInput", GoGetter: "ForLogDeliveryInput"},
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*DataDatabricksAwsAssumeRolePolicyConfig)(nil)).Elem(),
	)
}
