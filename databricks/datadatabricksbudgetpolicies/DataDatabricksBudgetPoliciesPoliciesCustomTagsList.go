...
func (j *jsiiProxy_DataDatabricksBudgetPoliciesPoliciesCustomTagsList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataDatabricksBudgetPoliciesPoliciesCustomTagsList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataDatabricksBudgetPoliciesPoliciesCustomTagsList {
	_init_.Initialize()
...
func NewDataDatabricksBudgetPoliciesPoliciesCustomTagsList_Override(d DataDatabricksBudgetPoliciesPoliciesCustomTagsList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataDatabricksBudgetPoliciesPoliciesCustomTagsList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataDatabricksBudgetPoliciesPoliciesCustomTagsList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataDatabricksBudgetPoliciesPoliciesCustomTagsList) Resolve(context cdktn.IResolveContext) interface{} {
