...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*PermissionAssignment)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*PermissionAssignmentConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktn/provider-databricks.permissionAssignment.PermissionAssignmentProviderConfig",
		reflect.TypeOf((*PermissionAssignmentProviderConfig)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktn/provider-databricks.permissionAssignment.PermissionAssignmentProviderConfigOutputReference",
		reflect.TypeOf((*PermissionAssignmentProviderConfigOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
