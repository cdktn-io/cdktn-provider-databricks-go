...
func init() {
	...
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "pscEndpointUriInput", GoGetter: "PscEndpointUriInput"},
			_jsii_.MemberMethod{JsiiMethod: "resetPscEndpointUri", GoMethod: "ResetPscEndpointUri"},
