...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*AccountIamDirectGroupMemberV2)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"@cdktn/provider-databricks.accountIamDirectGroupMemberV2.AccountIamDirectGroupMemberV2Config",
		reflect.TypeOf((*AccountIamDirectGroupMemberV2Config)(nil)).Elem(),
	)
}
