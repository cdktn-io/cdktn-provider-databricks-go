...
type DataDatabricksPolicyInfoColumnMaskUsing struct {
	...
	FunctionArgExpression *DataDatabricksPolicyInfoColumnMaskUsingFunctionArgExpression `field:"optional" json:"functionArgExpression" yaml:"functionArgExpression"`
}
