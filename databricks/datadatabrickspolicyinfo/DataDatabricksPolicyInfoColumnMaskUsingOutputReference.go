...
type DataDatabricksPolicyInfoColumnMaskUsingOutputReference interface {
	...
	// Experimental.
	Fqn() *string
	FunctionArgExpression() DataDatabricksPolicyInfoColumnMaskUsingFunctionArgExpressionOutputReference
	...
	PutFunctionArgExpression(value *DataDatabricksPolicyInfoColumnMaskUsingFunctionArgExpression)
	ResetAlias()
	ResetConstant()
...
func (j *jsiiProxy_DataDatabricksPolicyInfoColumnMaskUsingOutputReference) FunctionArgExpression() DataDatabricksPolicyInfoColumnMaskUsingFunctionArgExpressionOutputReference {
	var returns DataDatabricksPolicyInfoColumnMaskUsingFunctionArgExpressionOutputReference
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_DataDatabricksPolicyInfoColumnMaskUsingOutputReference) FunctionArgExpressionInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_DataDatabricksPolicyInfoColumnMaskUsingOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataDatabricksPolicyInfoColumnMaskUsingOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) DataDatabricksPolicyInfoColumnMaskUsingOutputReference {
	_init_.Initialize()
...
func NewDataDatabricksPolicyInfoColumnMaskUsingOutputReference_Override(d DataDatabricksPolicyInfoColumnMaskUsingOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataDatabricksPolicyInfoColumnMaskUsingOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataDatabricksPolicyInfoColumnMaskUsingOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataDatabricksPolicyInfoColumnMaskUsingOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (d *jsiiProxy_DataDatabricksPolicyInfoColumnMaskUsingOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataDatabricksPolicyInfoColumnMaskUsingOutputReference) PutFunctionArgExpression(value *DataDatabricksPolicyInfoColumnMaskUsingFunctionArgExpression) {
...
func (d *jsiiProxy_DataDatabricksPolicyInfoColumnMaskUsingOutputReference) ResetFunctionArgExpression() {
	_jsii_.InvokeVoid(
		d,
		"resetFunctionArgExpression",
		nil, // no parameters
...
func (d *jsiiProxy_DataDatabricksPolicyInfoColumnMaskUsingOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
