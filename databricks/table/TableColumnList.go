...
func (j *jsiiProxy_TableColumnList) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_TableColumnList) InternalValue() interface{} {
...
func (j *jsiiProxy_TableColumnList) TerraformAttribute() *string {
	var returns *string
	_jsii_.Get(
		j,
		"terraformAttribute",
...
func (j *jsiiProxy_TableColumnList) WrapsSet() *bool {
	var returns *bool
	_jsii_.Get(
		j,
		"wrapsSet",
...
func (j *jsiiProxy_TableColumnList)SetInternalValue(val interface{}) {
...
func (j *jsiiProxy_TableColumnList)SetTerraformAttribute(val *string) {
...
func (j *jsiiProxy_TableColumnList)SetWrapsSet(val *bool) {
...
func (t *jsiiProxy_TableColumnList) ComputeFqn() *string {
	var returns *string
...
func (t *jsiiProxy_TableColumnList) Get(index *float64) TableColumnOutputReference {
	if err := t.validateGetParameters(index); err != nil {
		panic(err)
	}
	var returns TableColumnOutputReference
...
func (t *jsiiProxy_TableColumnList) ToString() *string {
	var returns *string
