...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "dashboardNameContains", GoGetter: "DashboardNameContains"},
			_jsii_.MemberProperty{JsiiProperty: "dashboardNameContainsInput", GoGetter: "DashboardNameContainsInput"},
			_jsii_.MemberProperty{JsiiProperty: "dashboards", GoGetter: "Dashboards"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetDashboardNameContains", GoMethod: "ResetDashboardNameContains"},
