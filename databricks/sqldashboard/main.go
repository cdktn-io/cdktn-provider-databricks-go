...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*SqlDashboard)(nil)).Elem(),
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "dashboardFiltersEnabled", GoGetter: "DashboardFiltersEnabled"},
			_jsii_.MemberProperty{JsiiProperty: "dashboardFiltersEnabledInput", GoGetter: "DashboardFiltersEnabledInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetDashboardFiltersEnabled", GoMethod: "ResetDashboardFiltersEnabled"},
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*SqlDashboardConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktn/provider-databricks.sqlDashboard.SqlDashboardProviderConfig",
		reflect.TypeOf((*SqlDashboardProviderConfig)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktn/provider-databricks.sqlDashboard.SqlDashboardProviderConfigOutputReference",
		reflect.TypeOf((*SqlDashboardProviderConfigOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
