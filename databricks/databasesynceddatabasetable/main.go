...
func init() {
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*DatabaseSyncedDatabaseTableProviderConfig)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktn/provider-databricks.databaseSyncedDatabaseTable.DatabaseSyncedDatabaseTableProviderConfigOutputReference",
		reflect.TypeOf((*DatabaseSyncedDatabaseTableProviderConfigOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIndex", GoGetter: "ComplexObjectIndex"},
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIsFromSet", GoGetter: "ComplexObjectIsFromSet"},
			_jsii_.MemberMethod{JsiiMethod: "computeFqn", GoMethod: "ComputeFqn"},
	...
	_jsii_.RegisterStruct(
		"@cdktn/provider-databricks.databaseSyncedDatabaseTable.DatabaseSyncedDatabaseTableSpecTypeOverrides",
		reflect.TypeOf((*DatabaseSyncedDatabaseTableSpecTypeOverrides)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktn/provider-databricks.databaseSyncedDatabaseTable.DatabaseSyncedDatabaseTableSpecTypeOverridesList",
		reflect.TypeOf((*DatabaseSyncedDatabaseTableSpecTypeOverridesList)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DatabaseSyncedDatabaseTableSpecTypeOverridesOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
