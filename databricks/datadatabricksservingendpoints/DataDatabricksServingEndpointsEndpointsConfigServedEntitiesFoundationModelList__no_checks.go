...
func (d *jsiiProxy_DataDatabricksServingEndpointsEndpointsConfigServedEntitiesFoundationModelList) validateResolveParameters(context cdktn.IResolveContext) error {
	return nil
}
...
func (j *jsiiProxy_DataDatabricksServingEndpointsEndpointsConfigServedEntitiesFoundationModelList) validateSetTerraformResourceParameters(val cdktn.IInterpolatingParent) error {
	return nil
}
...
func validateNewDataDatabricksServingEndpointsEndpointsConfigServedEntitiesFoundationModelListParameters(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) error {
	return nil
}
