...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DisableLegacyAccessSetting)(nil)).Elem(),
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "disableLegacyAccess", GoGetter: "DisableLegacyAccess"},
			_jsii_.MemberProperty{JsiiProperty: "disableLegacyAccessInput", GoGetter: "DisableLegacyAccessInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "putDisableLegacyAccess", GoMethod: "PutDisableLegacyAccess"},
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*DisableLegacyAccessSettingProviderConfig)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktn/provider-databricks.disableLegacyAccessSetting.DisableLegacyAccessSettingProviderConfigOutputReference",
		reflect.TypeOf((*DisableLegacyAccessSettingProviderConfigOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIndex", GoGetter: "ComplexObjectIndex"},
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIsFromSet", GoGetter: "ComplexObjectIsFromSet"},
			_jsii_.MemberMethod{JsiiMethod: "computeFqn", GoMethod: "ComputeFqn"},
