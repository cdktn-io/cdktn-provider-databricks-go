...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*WorkspaceIamGroupV2)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"@cdktn/provider-databricks.workspaceIamGroupV2.WorkspaceIamGroupV2Config",
		reflect.TypeOf((*WorkspaceIamGroupV2Config)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktn/provider-databricks.workspaceIamGroupV2.WorkspaceIamGroupV2ProviderConfig",
		reflect.TypeOf((*WorkspaceIamGroupV2ProviderConfig)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktn/provider-databricks.workspaceIamGroupV2.WorkspaceIamGroupV2ProviderConfigOutputReference",
		reflect.TypeOf((*WorkspaceIamGroupV2ProviderConfigOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
