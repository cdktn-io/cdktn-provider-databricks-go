...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*ServicePrincipalRole)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*ServicePrincipalRoleConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktn/provider-databricks.servicePrincipalRole.ServicePrincipalRoleProviderConfig",
		reflect.TypeOf((*ServicePrincipalRoleProviderConfig)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktn/provider-databricks.servicePrincipalRole.ServicePrincipalRoleProviderConfigOutputReference",
		reflect.TypeOf((*ServicePrincipalRoleProviderConfigOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
