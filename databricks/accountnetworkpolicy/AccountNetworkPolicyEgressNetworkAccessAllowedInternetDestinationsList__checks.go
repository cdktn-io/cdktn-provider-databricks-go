...
func (a *jsiiProxy_AccountNetworkPolicyEgressNetworkAccessAllowedInternetDestinationsList) validateResolveParameters(context cdktn.IResolveContext) error {
	if context == nil {
...
func (j *jsiiProxy_AccountNetworkPolicyEgressNetworkAccessAllowedInternetDestinationsList) validateSetTerraformResourceParameters(val cdktn.IInterpolatingParent) error {
	if val == nil {
		return fmt.Errorf("parameter val is required, but nil was provided")
	}
...
func validateNewAccountNetworkPolicyEgressNetworkAccessAllowedInternetDestinationsListParameters(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) error {
