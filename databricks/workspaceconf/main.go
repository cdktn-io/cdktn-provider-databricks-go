...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*WorkspaceConf)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*WorkspaceConfConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktn/provider-databricks.workspaceConf.WorkspaceConfProviderConfig",
		reflect.TypeOf((*WorkspaceConfProviderConfig)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktn/provider-databricks.workspaceConf.WorkspaceConfProviderConfigOutputReference",
		reflect.TypeOf((*WorkspaceConfProviderConfigOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
