...
// Represents a {@link https://registry.terraform.io/providers/databricks/databricks/1.124.0/docs/resources/schema databricks_schema}.
type Schema interface {
	...
	ProviderConfig() SchemaProviderConfigOutputReference
	ProviderConfigInput() *SchemaProviderConfig
	// Experimental.
	...
	PutProviderConfig(value *SchemaProviderConfig)
...
func (j *jsiiProxy_Schema) CatalogName() *string {
	var returns *string
	_jsii_.Get(
		j,
		"catalogName",
...
func (j *jsiiProxy_Schema) CatalogNameInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"catalogNameInput",
...
func (j *jsiiProxy_Schema) ForceDestroy() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"forceDestroy",
...
func (j *jsiiProxy_Schema) ForceDestroyInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"forceDestroyInput",
...
func (j *jsiiProxy_Schema) MetastoreId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"metastoreId",
...
func (j *jsiiProxy_Schema) MetastoreIdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"metastoreIdInput",
...
func (j *jsiiProxy_Schema) Properties() *map[string]*string {
...
func (j *jsiiProxy_Schema) PropertiesInput() *map[string]*string {
	var returns *map[string]*string
	_jsii_.Get(
		j,
		"propertiesInput",
...
func (j *jsiiProxy_Schema) ProviderConfig() SchemaProviderConfigOutputReference {
	var returns SchemaProviderConfigOutputReference
	_jsii_.Get(
		j,
		"providerConfig",
		&returns,
...
func (j *jsiiProxy_Schema) ProviderConfigInput() *SchemaProviderConfig {
...
func (j *jsiiProxy_Schema) SchemaId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"schemaId",
...
// Create a new {@link https://registry.terraform.io/providers/databricks/databricks/1.124.0/docs/resources/schema databricks_schema} Resource.
...
func (j *jsiiProxy_Schema)SetCatalogName(val *string) {
...
func (j *jsiiProxy_Schema)SetForceDestroy(val interface{}) {
...
func (j *jsiiProxy_Schema)SetMetastoreId(val *string) {
...
func (j *jsiiProxy_Schema)SetProperties(val *map[string]*string) {
...
func (s *jsiiProxy_Schema) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (s *jsiiProxy_Schema) PutProviderConfig(value *SchemaProviderConfig) {
...
func (s *jsiiProxy_Schema) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (s *jsiiProxy_Schema) ResetForceDestroy() {
	_jsii_.InvokeVoid(
		s,
		"resetForceDestroy",
		nil, // no parameters
...
func (s *jsiiProxy_Schema) ResetMetastoreId() {
	_jsii_.InvokeVoid(
		s,
		"resetMetastoreId",
		nil, // no parameters
...
func (s *jsiiProxy_Schema) ResetProperties() {
	_jsii_.InvokeVoid(
		s,
		"resetProperties",
		nil, // no parameters
...
func (s *jsiiProxy_Schema) ResetProviderConfig() {
	_jsii_.InvokeVoid(
		s,
		"resetProviderConfig",
		nil, // no parameters
...
func (s *jsiiProxy_Schema) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
