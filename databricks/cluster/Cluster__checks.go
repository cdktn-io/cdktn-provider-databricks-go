...
func (c *jsiiProxy_Cluster) validatePutClusterMountInfoParameters(value interface{}) error {
	...
	case *[]*ClusterClusterMountInfo:
		value := value.(*[]*ClusterClusterMountInfo)
	...
	case []*ClusterClusterMountInfo:
		value_ := value.([]*ClusterClusterMountInfo)
		value := &value_
		for idx_cd4240, v := range *value {
			if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter value[%#v]", idx_cd4240) }); err != nil {
				return err
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktn.IResolvable, *[]*ClusterClusterMountInfo; received %#v (a %T)", value, value)
		}
	}
...
func (c *jsiiProxy_Cluster) validatePutInitScriptsParameters(value interface{}) error {
	...
	case cdktn.IResolvable:
		// ok
	case *[]*ClusterInitScripts:
		value := value.(*[]*ClusterInitScripts)
		for idx_cd4240, v := range *value {
			if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter value[%#v]", idx_cd4240) }); err != nil {
				return err
			}
	...
	case []*ClusterInitScripts:
		value_ := value.([]*ClusterInitScripts)
		value := &value_
		for idx_cd4240, v := range *value {
			if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter value[%#v]", idx_cd4240) }); err != nil {
				return err
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktn.IResolvable, *[]*ClusterInitScripts; received %#v (a %T)", value, value)
		}
	}
...
func (c *jsiiProxy_Cluster) validatePutLibraryParameters(value interface{}) error {
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktn.IResolvable, *[]*ClusterLibrary; received %#v (a %T)", value, value)
		}
	}
