...
func (j *jsiiProxy_ClusterGcpAttributesOutputReference) FirstOnDemand() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
		"firstOnDemand",
...
func (j *jsiiProxy_ClusterGcpAttributesOutputReference) FirstOnDemandInput() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
		"firstOnDemandInput",
...
func (j *jsiiProxy_ClusterGcpAttributesOutputReference)SetFirstOnDemand(val *float64) {
...
func (c *jsiiProxy_ClusterGcpAttributesOutputReference) ResetFirstOnDemand() {
	_jsii_.InvokeVoid(
		c,
		"resetFirstOnDemand",
		nil, // no parameters
