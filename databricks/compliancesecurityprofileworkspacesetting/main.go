...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*ComplianceSecurityProfileWorkspaceSetting)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberMethod{JsiiMethod: "addMoveTarget", GoMethod: "AddMoveTarget"},
			_jsii_.MemberMethod{JsiiMethod: "addOverride", GoMethod: "AddOverride"},
			_jsii_.MemberProperty{JsiiProperty: "cdktfStack", GoGetter: "CdktfStack"},
			_jsii_.MemberProperty{JsiiProperty: "complianceSecurityProfileWorkspace", GoGetter: "ComplianceSecurityProfileWorkspace"},
			_jsii_.MemberProperty{JsiiProperty: "complianceSecurityProfileWorkspaceInput", GoGetter: "ComplianceSecurityProfileWorkspaceInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "putComplianceSecurityProfileWorkspace", GoMethod: "PutComplianceSecurityProfileWorkspace"},
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*ComplianceSecurityProfileWorkspaceSettingComplianceSecurityProfileWorkspace)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*ComplianceSecurityProfileWorkspaceSettingComplianceSecurityProfileWorkspaceOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*ComplianceSecurityProfileWorkspaceSettingConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*ComplianceSecurityProfileWorkspaceSettingProviderConfig)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*ComplianceSecurityProfileWorkspaceSettingProviderConfigOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIndex", GoGetter: "ComplexObjectIndex"},
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIsFromSet", GoGetter: "ComplexObjectIsFromSet"},
			_jsii_.MemberMethod{JsiiMethod: "computeFqn", GoMethod: "ComputeFqn"},
