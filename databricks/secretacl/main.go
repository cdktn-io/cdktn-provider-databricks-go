...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*SecretAcl)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*SecretAclConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktn/provider-databricks.secretAcl.SecretAclProviderConfig",
		reflect.TypeOf((*SecretAclProviderConfig)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktn/provider-databricks.secretAcl.SecretAclProviderConfigOutputReference",
		reflect.TypeOf((*SecretAclProviderConfigOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
