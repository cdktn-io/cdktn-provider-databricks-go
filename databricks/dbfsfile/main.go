...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DbfsFile)(nil)).Elem(),
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "dbfsPath", GoGetter: "DbfsPath"},
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*DbfsFileConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktn/provider-databricks.dbfsFile.DbfsFileProviderConfig",
		reflect.TypeOf((*DbfsFileProviderConfig)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktn/provider-databricks.dbfsFile.DbfsFileProviderConfigOutputReference",
		reflect.TypeOf((*DbfsFileProviderConfigOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
