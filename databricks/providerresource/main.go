...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*ProviderResource)(nil)).Elem(),
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "recipientProfileStr", GoGetter: "RecipientProfileStr"},
			_jsii_.MemberProperty{JsiiProperty: "recipientProfileStrInput", GoGetter: "RecipientProfileStrInput"},
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*ProviderResourceConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktn/provider-databricks.providerResource.ProviderResourceProviderConfig",
		reflect.TypeOf((*ProviderResourceProviderConfig)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktn/provider-databricks.providerResource.ProviderResourceProviderConfigOutputReference",
		reflect.TypeOf((*ProviderResourceProviderConfigOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
