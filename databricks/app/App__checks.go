...
func (a *jsiiProxy_App) validatePutResourcesParameters(value interface{}) error {
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktn.IResolvable, *[]*AppResources; received %#v (a %T)", value, value)
		}
	}
...
func (a *jsiiProxy_App) validatePutTelemetryExportDestinationsParameters(value interface{}) error {
	...
	case cdktn.IResolvable:
		// ok
	case *[]*AppTelemetryExportDestinations:
		value := value.(*[]*AppTelemetryExportDestinations)
		for idx_cd4240, v := range *value {
			if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter value[%#v]", idx_cd4240) }); err != nil {
				return err
			}
	...
	case []*AppTelemetryExportDestinations:
		value_ := value.([]*AppTelemetryExportDestinations)
		value := &value_
		for idx_cd4240, v := range *value {
			if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter value[%#v]", idx_cd4240) }); err != nil {
				return err
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktn.IResolvable, *[]*AppTelemetryExportDestinations; received %#v (a %T)", value, value)
		}
	}
