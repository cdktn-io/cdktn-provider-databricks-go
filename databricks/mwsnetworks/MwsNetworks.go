...
// Represents a {@link https://registry.terraform.io/providers/databricks/databricks/1.127.0/docs/resources/mws_networks databricks_mws_networks}.
...
func (j *jsiiProxy_MwsNetworks) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_MwsNetworks) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_MwsNetworks) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_MwsNetworks) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_MwsNetworks) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/databricks/databricks/1.127.0/docs/resources/mws_networks databricks_mws_networks} Resource.
func NewMwsNetworks(scope constructs.Construct, id *string, config *MwsNetworksConfig) MwsNetworks {
	_init_.Initialize()

	if err := validateNewMwsNetworksParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_MwsNetworks)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_MwsNetworks)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_MwsNetworks)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func (j *jsiiProxy_MwsNetworks)SetVpcStatus(val *string) {
	if err := j.validateSetVpcStatusParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func MwsNetworks_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()

	if err := validateMwsNetworks_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func MwsNetworks_IsConstruct(x interface{}) *bool {
	...
	if err := validateMwsNetworks_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (m *jsiiProxy_MwsNetworks) AddMoveTarget(moveTarget *string) {
...
func (m *jsiiProxy_MwsNetworks) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (m *jsiiProxy_MwsNetworks) HasResourceMove() interface{} {
	var returns interface{}
...
func (m *jsiiProxy_MwsNetworks) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (m *jsiiProxy_MwsNetworks) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (m *jsiiProxy_MwsNetworks) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (m *jsiiProxy_MwsNetworks) MoveFromId(id *string) {
...
func (m *jsiiProxy_MwsNetworks) MoveTo(moveTarget *string, index interface{}) {
...
func (m *jsiiProxy_MwsNetworks) MoveToId(id *string) {
...
func (m *jsiiProxy_MwsNetworks) PutErrorMessages(value interface{}) {
	if err := m.validatePutErrorMessagesParameters(value); err != nil {
		panic(err)
	}
	_jsii_.InvokeVoid(
		m,
...
func (m *jsiiProxy_MwsNetworks) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (m *jsiiProxy_MwsNetworks) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (m *jsiiProxy_MwsNetworks) ToHclTerraform() interface{} {
	var returns interface{}
