...
func (j *jsiiProxy_MwsNetworksErrorMessagesList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewMwsNetworksErrorMessagesList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) MwsNetworksErrorMessagesList {
	_init_.Initialize()
...
func NewMwsNetworksErrorMessagesList_Override(m MwsNetworksErrorMessagesList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_MwsNetworksErrorMessagesList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (m *jsiiProxy_MwsNetworksErrorMessagesList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (m *jsiiProxy_MwsNetworksErrorMessagesList) Resolve(context cdktn.IResolveContext) interface{} {
