...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*UserInstanceProfile)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*UserInstanceProfileConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktn/provider-databricks.userInstanceProfile.UserInstanceProfileProviderConfig",
		reflect.TypeOf((*UserInstanceProfileProviderConfig)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktn/provider-databricks.userInstanceProfile.UserInstanceProfileProviderConfigOutputReference",
		reflect.TypeOf((*UserInstanceProfileProviderConfigOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
