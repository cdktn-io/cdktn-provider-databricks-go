...
func init() {
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*DataDatabricksUserConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktn/provider-databricks.dataDatabricksUser.DataDatabricksUserProviderConfig",
		reflect.TypeOf((*DataDatabricksUserProviderConfig)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktn/provider-databricks.dataDatabricksUser.DataDatabricksUserProviderConfigOutputReference",
		reflect.TypeOf((*DataDatabricksUserProviderConfigOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
