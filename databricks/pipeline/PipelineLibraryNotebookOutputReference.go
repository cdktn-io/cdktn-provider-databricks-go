...
func (j *jsiiProxy_PipelineLibraryNotebookOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewPipelineLibraryNotebookOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) PipelineLibraryNotebookOutputReference {
	_init_.Initialize()
...
func NewPipelineLibraryNotebookOutputReference_Override(p PipelineLibraryNotebookOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_PipelineLibraryNotebookOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (p *jsiiProxy_PipelineLibraryNotebookOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (p *jsiiProxy_PipelineLibraryNotebookOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (p *jsiiProxy_PipelineLibraryNotebookOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (p *jsiiProxy_PipelineLibraryNotebookOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
