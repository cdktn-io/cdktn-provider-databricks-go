...
type PipelineIngestionDefinitionSourceConfigurations struct {
	...
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/databricks/databricks/1.125.0/docs/resources/pipeline#google_ads_config Pipeline#google_ads_config}
