...
type PipelineIngestionDefinitionObjectsSchemaConnectorOptionsKafkaOptionsKeyTransformerProtobufOptions struct {
	...
	SchemaRegistry *PipelineIngestionDefinitionObjectsSchemaConnectorOptionsKafkaOptionsKeyTransformerProtobufOptionsSchemaRegistry `field:"optional" json:"schemaRegistry" yaml:"schemaRegistry"`
}
