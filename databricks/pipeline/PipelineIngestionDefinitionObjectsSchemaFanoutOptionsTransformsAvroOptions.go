...
type PipelineIngestionDefinitionObjectsSchemaFanoutOptionsTransformsAvroOptions struct {
	...
	SchemaRegistry *PipelineIngestionDefinitionObjectsSchemaFanoutOptionsTransformsAvroOptionsSchemaRegistry `field:"optional" json:"schemaRegistry" yaml:"schemaRegistry"`
}
