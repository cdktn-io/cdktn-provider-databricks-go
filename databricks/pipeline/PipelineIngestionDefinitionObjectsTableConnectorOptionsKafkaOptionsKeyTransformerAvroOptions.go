...
type PipelineIngestionDefinitionObjectsTableConnectorOptionsKafkaOptionsKeyTransformerAvroOptions struct {
	...
	SchemaRegistry *PipelineIngestionDefinitionObjectsTableConnectorOptionsKafkaOptionsKeyTransformerAvroOptionsSchemaRegistry `field:"optional" json:"schemaRegistry" yaml:"schemaRegistry"`
}
