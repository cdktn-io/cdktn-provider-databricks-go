...
func (p *jsiiProxy_Pipeline) validatePutClusterParameters(value interface{}) error {
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktn.IResolvable, *[]*PipelineCluster; received %#v (a %T)", value, value)
		}
	}
...
func (p *jsiiProxy_Pipeline) validatePutLatestUpdatesParameters(value interface{}) error {
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktn.IResolvable, *[]*PipelineLatestUpdates; received %#v (a %T)", value, value)
		}
	}
...
func (p *jsiiProxy_Pipeline) validatePutLibraryParameters(value interface{}) error {
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktn.IResolvable, *[]*PipelineLibrary; received %#v (a %T)", value, value)
		}
	}
...
func (p *jsiiProxy_Pipeline) validatePutNotificationParameters(value interface{}) error {
	...
	case *[]*PipelineNotification:
		value := value.(*[]*PipelineNotification)
		for idx_cd4240, v := range *value {
			if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter value[%#v]", idx_cd4240) }); err != nil {
				return err
			}
	...
	case []*PipelineNotification:
		value_ := value.([]*PipelineNotification)
		value := &value_
		for idx_cd4240, v := range *value {
			if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter value[%#v]", idx_cd4240) }); err != nil {
				return err
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktn.IResolvable, *[]*PipelineNotification; received %#v (a %T)", value, value)
		}
	}
