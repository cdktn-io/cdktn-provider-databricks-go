...
type PipelineIngestionDefinitionObjectsSchemaFanoutOptionsTransformsAvroOptionsSchemaRegistry struct {
	...
	ConfluentOptions *PipelineIngestionDefinitionObjectsSchemaFanoutOptionsTransformsAvroOptionsSchemaRegistryConfluentOptions `field:"optional" json:"confluentOptions" yaml:"confluentOptions"`
