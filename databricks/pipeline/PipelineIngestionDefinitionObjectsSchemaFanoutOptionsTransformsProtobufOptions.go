...
type PipelineIngestionDefinitionObjectsSchemaFanoutOptionsTransformsProtobufOptions struct {
	...
	SchemaRegistry *PipelineIngestionDefinitionObjectsSchemaFanoutOptionsTransformsProtobufOptionsSchemaRegistry `field:"optional" json:"schemaRegistry" yaml:"schemaRegistry"`
}
