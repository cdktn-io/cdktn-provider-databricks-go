...
type PipelineIngestionDefinitionSourceConfigurationsCatalog struct {
	// postgres block.
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/databricks/databricks/1.126.0/docs/resources/pipeline#postgres Pipeline#postgres}
