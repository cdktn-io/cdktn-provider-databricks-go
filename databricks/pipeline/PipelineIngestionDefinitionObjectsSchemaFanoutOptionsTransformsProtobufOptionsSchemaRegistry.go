...
type PipelineIngestionDefinitionObjectsSchemaFanoutOptionsTransformsProtobufOptionsSchemaRegistry struct {
	...
	ConfluentOptions *PipelineIngestionDefinitionObjectsSchemaFanoutOptionsTransformsProtobufOptionsSchemaRegistryConfluentOptions `field:"optional" json:"confluentOptions" yaml:"confluentOptions"`
