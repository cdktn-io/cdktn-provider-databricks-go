...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataDatabricksMaterializedFeaturesFeatureTag)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*DataDatabricksMaterializedFeaturesFeatureTagConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*DataDatabricksMaterializedFeaturesFeatureTagProviderConfig)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataDatabricksMaterializedFeaturesFeatureTagProviderConfigOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
