...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*SqlWidget)(nil)).Elem(),
		[]_jsii_.Member{
			...
			_jsii_.MemberMethod{JsiiMethod: "resetVisualizationId", GoMethod: "ResetVisualizationId"},
			_jsii_.MemberMethod{JsiiMethod: "resetWidgetId", GoMethod: "ResetWidgetId"},
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*SqlWidgetConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktn/provider-databricks.sqlWidget.SqlWidgetParameter",
		reflect.TypeOf((*SqlWidgetParameter)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktn/provider-databricks.sqlWidget.SqlWidgetParameterList",
		reflect.TypeOf((*SqlWidgetParameterList)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*SqlWidgetParameterOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
			...
			_jsii_.MemberMethod{JsiiMethod: "interpolationForAttribute", GoMethod: "InterpolationForAttribute"},
			_jsii_.MemberProperty{JsiiProperty: "mapTo", GoGetter: "MapTo"},
			_jsii_.MemberProperty{JsiiProperty: "mapToInput", GoGetter: "MapToInput"},
			_jsii_.MemberProperty{JsiiProperty: "name", GoGetter: "Name"},
			_jsii_.MemberProperty{JsiiProperty: "nameInput", GoGetter: "NameInput"},
			_jsii_.MemberMethod{JsiiMethod: "resetMapTo", GoMethod: "ResetMapTo"},
			_jsii_.MemberMethod{JsiiMethod: "resetTitle", GoMethod: "ResetTitle"},
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*SqlWidgetPosition)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktn/provider-databricks.sqlWidget.SqlWidgetPositionOutputReference",
		reflect.TypeOf((*SqlWidgetPositionOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberProperty{JsiiProperty: "autoHeight", GoGetter: "AutoHeight"},
			_jsii_.MemberProperty{JsiiProperty: "autoHeightInput", GoGetter: "AutoHeightInput"},
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIndex", GoGetter: "ComplexObjectIndex"},
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIsFromSet", GoGetter: "ComplexObjectIsFromSet"},
			_jsii_.MemberMethod{JsiiMethod: "computeFqn", GoMethod: "ComputeFqn"},
			_jsii_.MemberProperty{JsiiProperty: "creationStack", GoGetter: "CreationStack"},
			...
			_jsii_.MemberMethod{JsiiMethod: "interpolationAsList", GoMethod: "InterpolationAsList"},
			_jsii_.MemberMethod{JsiiMethod: "interpolationForAttribute", GoMethod: "InterpolationForAttribute"},
			_jsii_.MemberProperty{JsiiProperty: "posX", GoGetter: "PosX"},
			_jsii_.MemberProperty{JsiiProperty: "posXInput", GoGetter: "PosXInput"},
			_jsii_.MemberProperty{JsiiProperty: "posY", GoGetter: "PosY"},
			_jsii_.MemberProperty{JsiiProperty: "posYInput", GoGetter: "PosYInput"},
			_jsii_.MemberMethod{JsiiMethod: "resetAutoHeight", GoMethod: "ResetAutoHeight"},
			_jsii_.MemberMethod{JsiiMethod: "resetPosX", GoMethod: "ResetPosX"},
			_jsii_.MemberMethod{JsiiMethod: "resetPosY", GoMethod: "ResetPosY"},
			_jsii_.MemberMethod{JsiiMethod: "resolve", GoMethod: "Resolve"},
			_jsii_.MemberProperty{JsiiProperty: "sizeX", GoGetter: "SizeX"},
			_jsii_.MemberProperty{JsiiProperty: "sizeXInput", GoGetter: "SizeXInput"},
			_jsii_.MemberProperty{JsiiProperty: "sizeY", GoGetter: "SizeY"},
			_jsii_.MemberProperty{JsiiProperty: "sizeYInput", GoGetter: "SizeYInput"},
			_jsii_.MemberProperty{JsiiProperty: "terraformAttribute", GoGetter: "TerraformAttribute"},
			_jsii_.MemberProperty{JsiiProperty: "terraformResource", GoGetter: "TerraformResource"},
			_jsii_.MemberMethod{JsiiMethod: "toString", GoMethod: "ToString"},
		},
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*SqlWidgetProviderConfig)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktn/provider-databricks.sqlWidget.SqlWidgetProviderConfigOutputReference",
		reflect.TypeOf((*SqlWidgetProviderConfigOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIndex", GoGetter: "ComplexObjectIndex"},
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIsFromSet", GoGetter: "ComplexObjectIsFromSet"},
			_jsii_.MemberMethod{JsiiMethod: "computeFqn", GoMethod: "ComputeFqn"},
