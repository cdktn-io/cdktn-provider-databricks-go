...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*IpAccessList)(nil)).Elem(),
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "listType", GoGetter: "ListType"},
			_jsii_.MemberProperty{JsiiProperty: "listTypeInput", GoGetter: "ListTypeInput"},
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*IpAccessListConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktn/provider-databricks.ipAccessList.IpAccessListProviderConfig",
		reflect.TypeOf((*IpAccessListProviderConfig)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktn/provider-databricks.ipAccessList.IpAccessListProviderConfigOutputReference",
		reflect.TypeOf((*IpAccessListProviderConfigOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
