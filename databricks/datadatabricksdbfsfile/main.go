...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataDatabricksDbfsFile)(nil)).Elem(),
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "limitFileSize", GoGetter: "LimitFileSize"},
			_jsii_.MemberProperty{JsiiProperty: "limitFileSizeInput", GoGetter: "LimitFileSizeInput"},
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*DataDatabricksDbfsFileConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktn/provider-databricks.dataDatabricksDbfsFile.DataDatabricksDbfsFileProviderConfig",
		reflect.TypeOf((*DataDatabricksDbfsFileProviderConfig)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktn/provider-databricks.dataDatabricksDbfsFile.DataDatabricksDbfsFileProviderConfigOutputReference",
		reflect.TypeOf((*DataDatabricksDbfsFileProviderConfigOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
