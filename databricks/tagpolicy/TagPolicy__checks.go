...
func (t *jsiiProxy_TagPolicy) validatePutValuesParameters(value interface{}) error {
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktn.IResolvable, *[]*TagPolicyValues; received %#v (a %T)", value, value)
		}
	}
