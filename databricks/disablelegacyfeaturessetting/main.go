...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DisableLegacyFeaturesSetting)(nil)).Elem(),
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "disableLegacyFeatures", GoGetter: "DisableLegacyFeatures"},
			_jsii_.MemberProperty{JsiiProperty: "disableLegacyFeaturesInput", GoGetter: "DisableLegacyFeaturesInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "putDisableLegacyFeatures", GoMethod: "PutDisableLegacyFeatures"},
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*DisableLegacyFeaturesSettingProviderConfig)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktn/provider-databricks.disableLegacyFeaturesSetting.DisableLegacyFeaturesSettingProviderConfigOutputReference",
		reflect.TypeOf((*DisableLegacyFeaturesSettingProviderConfigOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIndex", GoGetter: "ComplexObjectIndex"},
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIsFromSet", GoGetter: "ComplexObjectIsFromSet"},
			_jsii_.MemberMethod{JsiiMethod: "computeFqn", GoMethod: "ComputeFqn"},
