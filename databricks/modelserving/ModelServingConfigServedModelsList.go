...
func (j *jsiiProxy_ModelServingConfigServedModelsList) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_ModelServingConfigServedModelsList) InternalValue() interface{} {
...
func (j *jsiiProxy_ModelServingConfigServedModelsList) TerraformAttribute() *string {
	var returns *string
	_jsii_.Get(
		j,
		"terraformAttribute",
...
func (j *jsiiProxy_ModelServingConfigServedModelsList) WrapsSet() *bool {
	var returns *bool
	_jsii_.Get(
		j,
		"wrapsSet",
...
func (j *jsiiProxy_ModelServingConfigServedModelsList)SetInternalValue(val interface{}) {
...
func (j *jsiiProxy_ModelServingConfigServedModelsList)SetTerraformAttribute(val *string) {
...
func (j *jsiiProxy_ModelServingConfigServedModelsList)SetWrapsSet(val *bool) {
...
func (m *jsiiProxy_ModelServingConfigServedModelsList) ComputeFqn() *string {
	var returns *string
...
func (m *jsiiProxy_ModelServingConfigServedModelsList) Get(index *float64) ModelServingConfigServedModelsOutputReference {
	if err := m.validateGetParameters(index); err != nil {
		panic(err)
	}
	var returns ModelServingConfigServedModelsOutputReference
...
func (m *jsiiProxy_ModelServingConfigServedModelsList) ToString() *string {
	var returns *string
