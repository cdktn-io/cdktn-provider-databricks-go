...
type DataDatabricksJobJobSettingsSettingsTriggerTableUpdate struct {
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/databricks/databricks/1.115.0/docs/data-sources/job#table_names DataDatabricksJob#table_names}.
	TableNames *[]*string `field:"required" json:"tableNames" yaml:"tableNames"`
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/databricks/databricks/1.115.0/docs/data-sources/job#condition DataDatabricksJob#condition}.
