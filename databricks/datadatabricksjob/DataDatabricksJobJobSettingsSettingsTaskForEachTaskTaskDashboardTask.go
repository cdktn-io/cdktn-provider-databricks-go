...
type DataDatabricksJobJobSettingsSettingsTaskForEachTaskTaskDashboardTask struct {
	...
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/databricks/databricks/1.114.2/docs/data-sources/job#filters DataDatabricksJob#filters}.
	Filters *map[string]*string `field:"optional" json:"filters" yaml:"filters"`
	// subscription block.
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/databricks/databricks/1.114.2/docs/data-sources/job#subscription DataDatabricksJob#subscription}
