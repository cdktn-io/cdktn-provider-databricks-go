...
type DataDatabricksJobJobSettingsSettingsDbtTask struct {
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/databricks/databricks/1.119.0/docs/data-sources/job#commands DataDatabricksJob#commands}.
	...
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/databricks/databricks/1.119.0/docs/data-sources/job#profiles_directory DataDatabricksJob#profiles_directory}.
	ProfilesDirectory *string `field:"optional" json:"profilesDirectory" yaml:"profilesDirectory"`
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/databricks/databricks/1.119.0/docs/data-sources/job#project_directory DataDatabricksJob#project_directory}.
