...
type DataDatabricksJobConfig struct {
	...
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/databricks/databricks/1.129.0/docs/data-sources/job#id DataDatabricksJob#id}.
	//
	...
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/databricks/databricks/1.129.0/docs/data-sources/job#job_name DataDatabricksJob#job_name}.
	JobName *string `field:"optional" json:"jobName" yaml:"jobName"`
	// job_settings block.
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/databricks/databricks/1.129.0/docs/data-sources/job#job_settings DataDatabricksJob#job_settings}
