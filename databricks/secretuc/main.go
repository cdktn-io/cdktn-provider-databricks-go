...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*SecretUc)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"@cdktn/provider-databricks.secretUc.SecretUcConfig",
		reflect.TypeOf((*SecretUcConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktn/provider-databricks.secretUc.SecretUcProviderConfig",
		reflect.TypeOf((*SecretUcProviderConfig)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktn/provider-databricks.secretUc.SecretUcProviderConfigOutputReference",
		reflect.TypeOf((*SecretUcProviderConfigOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
