...
type DataDatabricksAppsSpacesConfig struct {
	// Experimental.
	...
	ProviderConfig *DataDatabricksAppsSpacesProviderConfig `field:"optional" json:"providerConfig" yaml:"providerConfig"`
}
