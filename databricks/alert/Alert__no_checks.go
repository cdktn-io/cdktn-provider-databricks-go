...
func (a *jsiiProxy_Alert) validatePutProviderConfigParameters(value *AlertProviderConfig) error {
	return nil
}
...
func (j *jsiiProxy_Alert) validateSetLifecycleParameters(val *cdktn.TerraformResourceLifecycle) error {
	return nil
}
