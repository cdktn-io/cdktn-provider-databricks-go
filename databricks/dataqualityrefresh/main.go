...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataQualityRefresh)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*DataQualityRefreshConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktn/provider-databricks.dataQualityRefresh.DataQualityRefreshProviderConfig",
		reflect.TypeOf((*DataQualityRefreshProviderConfig)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktn/provider-databricks.dataQualityRefresh.DataQualityRefreshProviderConfigOutputReference",
		reflect.TypeOf((*DataQualityRefreshProviderConfigOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
