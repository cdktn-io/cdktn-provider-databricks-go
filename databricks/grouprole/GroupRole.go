...
import (
	...
	"github.com/cdktn-io/cdktn-provider-databricks-go/databricks/v18/grouprole/internal"
	"github.com/open-constructs/cdk-terrain-go/cdktn"
)

// Represents a {@link https://registry.terraform.io/providers/databricks/databricks/1.124.0/docs/resources/group_role databricks_group_role}.
type GroupRole interface {
	...
	ProviderConfig() GroupRoleProviderConfigOutputReference
	ProviderConfigInput() *GroupRoleProviderConfig
	// Experimental.
	...
	PutProviderConfig(value *GroupRoleProviderConfig)
...
func (j *jsiiProxy_GroupRole) Api() *string {
	var returns *string
	_jsii_.Get(
		j,
		"api",
...
func (j *jsiiProxy_GroupRole) ApiInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"apiInput",
...
func (j *jsiiProxy_GroupRole) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_GroupRole) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_GroupRole) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_GroupRole) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_GroupRole) ProviderConfig() GroupRoleProviderConfigOutputReference {
	var returns GroupRoleProviderConfigOutputReference
	_jsii_.Get(
		j,
		"providerConfig",
		&returns,
...
func (j *jsiiProxy_GroupRole) ProviderConfigInput() *GroupRoleProviderConfig {
...
func (j *jsiiProxy_GroupRole) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/databricks/databricks/1.124.0/docs/resources/group_role databricks_group_role} Resource.
...
func (j *jsiiProxy_GroupRole)SetApi(val *string) {
...
func (j *jsiiProxy_GroupRole)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_GroupRole)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_GroupRole)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func GroupRole_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()

	if err := validateGroupRole_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (g *jsiiProxy_GroupRole) AddMoveTarget(moveTarget *string) {
...
func (g *jsiiProxy_GroupRole) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (g *jsiiProxy_GroupRole) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (g *jsiiProxy_GroupRole) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (g *jsiiProxy_GroupRole) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (g *jsiiProxy_GroupRole) MoveFromId(id *string) {
...
func (g *jsiiProxy_GroupRole) MoveToId(id *string) {
...
func (g *jsiiProxy_GroupRole) PutProviderConfig(value *GroupRoleProviderConfig) {
...
func (g *jsiiProxy_GroupRole) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (g *jsiiProxy_GroupRole) ResetApi() {
	_jsii_.InvokeVoid(
		g,
		"resetApi",
		nil, // no parameters
...
func (g *jsiiProxy_GroupRole) ResetProviderConfig() {
	_jsii_.InvokeVoid(
		g,
		"resetProviderConfig",
		nil, // no parameters
...
func (g *jsiiProxy_GroupRole) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
