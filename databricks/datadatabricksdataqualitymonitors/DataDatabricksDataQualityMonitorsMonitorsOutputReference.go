...
type DataDatabricksDataQualityMonitorsMonitorsOutputReference interface {
	...
	ProviderConfig() DataDatabricksDataQualityMonitorsMonitorsProviderConfigOutputReference
	...
	PutProviderConfig(value *DataDatabricksDataQualityMonitorsMonitorsProviderConfig)
	ResetProviderConfig()
...
func (j *jsiiProxy_DataDatabricksDataQualityMonitorsMonitorsOutputReference) ProviderConfig() DataDatabricksDataQualityMonitorsMonitorsProviderConfigOutputReference {
	var returns DataDatabricksDataQualityMonitorsMonitorsProviderConfigOutputReference
	_jsii_.Get(
		j,
		"providerConfig",
		&returns,
...
func (j *jsiiProxy_DataDatabricksDataQualityMonitorsMonitorsOutputReference) ProviderConfigInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"providerConfigInput",
...
func (j *jsiiProxy_DataDatabricksDataQualityMonitorsMonitorsOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataDatabricksDataQualityMonitorsMonitorsOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) DataDatabricksDataQualityMonitorsMonitorsOutputReference {
	_init_.Initialize()
...
func NewDataDatabricksDataQualityMonitorsMonitorsOutputReference_Override(d DataDatabricksDataQualityMonitorsMonitorsOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataDatabricksDataQualityMonitorsMonitorsOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataDatabricksDataQualityMonitorsMonitorsOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataDatabricksDataQualityMonitorsMonitorsOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (d *jsiiProxy_DataDatabricksDataQualityMonitorsMonitorsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataDatabricksDataQualityMonitorsMonitorsOutputReference) PutProviderConfig(value *DataDatabricksDataQualityMonitorsMonitorsProviderConfig) {
...
func (d *jsiiProxy_DataDatabricksDataQualityMonitorsMonitorsOutputReference) ResetProviderConfig() {
	_jsii_.InvokeVoid(
		d,
		"resetProviderConfig",
		nil, // no parameters
...
func (d *jsiiProxy_DataDatabricksDataQualityMonitorsMonitorsOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
