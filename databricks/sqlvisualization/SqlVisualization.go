...
// Represents a {@link https://registry.terraform.io/providers/databricks/databricks/1.125.0/docs/resources/sql_visualization databricks_sql_visualization}.
...
func (j *jsiiProxy_SqlVisualization) Connection() interface{} {
...
func (j *jsiiProxy_SqlVisualization) ConstructNodeMetadata() *map[string]interface{} {
...
func (j *jsiiProxy_SqlVisualization) DependsOn() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"dependsOn",
...
func (j *jsiiProxy_SqlVisualization) Description() *string {
	var returns *string
	_jsii_.Get(
		j,
		"description",
...
func (j *jsiiProxy_SqlVisualization) DescriptionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"descriptionInput",
...
func (j *jsiiProxy_SqlVisualization) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_SqlVisualization) FriendlyUniqueId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"friendlyUniqueId",
...
func (j *jsiiProxy_SqlVisualization) Id() *string {
	var returns *string
	_jsii_.Get(
		j,
		"id",
...
func (j *jsiiProxy_SqlVisualization) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func (j *jsiiProxy_SqlVisualization) Name() *string {
	var returns *string
	_jsii_.Get(
		j,
		"name",
...
func (j *jsiiProxy_SqlVisualization) NameInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"nameInput",
...
func (j *jsiiProxy_SqlVisualization) Node() constructs.Node {
...
func (j *jsiiProxy_SqlVisualization) Options() *string {
	var returns *string
	_jsii_.Get(
		j,
		"options",
...
func (j *jsiiProxy_SqlVisualization) OptionsInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"optionsInput",
...
func (j *jsiiProxy_SqlVisualization) Provisioners() *[]interface{} {
	var returns *[]interface{}
	_jsii_.Get(
		j,
		"provisioners",
...
func (j *jsiiProxy_SqlVisualization) QueryId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"queryId",
...
func (j *jsiiProxy_SqlVisualization) QueryIdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"queryIdInput",
...
func (j *jsiiProxy_SqlVisualization) TerraformMetaArguments() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_SqlVisualization) TerraformResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_SqlVisualization) Type() *string {
	var returns *string
	_jsii_.Get(
		j,
		"type",
...
func (j *jsiiProxy_SqlVisualization) TypeInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"typeInput",
...
func (j *jsiiProxy_SqlVisualization) VisualizationId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"visualizationId",
...
func (j *jsiiProxy_SqlVisualization) VisualizationIdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
...
// Create a new {@link https://registry.terraform.io/providers/databricks/databricks/1.125.0/docs/resources/sql_visualization databricks_sql_visualization} Resource.
...
// Experimental.
func SqlVisualization_IsTerraformElement(x interface{}) *bool {
	_init_.Initialize()

	if err := validateSqlVisualization_IsTerraformElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func SqlVisualization_IsTerraformResource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateSqlVisualization_IsTerraformResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func SqlVisualization_TfResourceType() *string {
	_init_.Initialize()
	var returns *string
	_jsii_.StaticGet(
		"@cdktn/provider-databricks.sqlVisualization.SqlVisualization",
...
func (s *jsiiProxy_SqlVisualization) AddMoveTarget(moveTarget *string) {
...
func (s *jsiiProxy_SqlVisualization) HasResourceMove() interface{} {
	var returns interface{}
...
func (s *jsiiProxy_SqlVisualization) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (s *jsiiProxy_SqlVisualization) MoveFromId(id *string) {
...
func (s *jsiiProxy_SqlVisualization) MoveTo(moveTarget *string, index interface{}) {
...
func (s *jsiiProxy_SqlVisualization) MoveToId(id *string) {
...
func (s *jsiiProxy_SqlVisualization) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (s *jsiiProxy_SqlVisualization) ResetId() {
	_jsii_.InvokeVoid(
		s,
		"resetId",
		nil, // no parameters
...
func (s *jsiiProxy_SqlVisualization) ResetOverrideLogicalId() {
	_jsii_.InvokeVoid(
		s,
		"resetOverrideLogicalId",
		nil, // no parameters
...
func (s *jsiiProxy_SqlVisualization) ResetVisualizationId() {
	_jsii_.InvokeVoid(
		s,
		"resetVisualizationId",
		nil, // no parameters
...
func (s *jsiiProxy_SqlVisualization) SynthesizeAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (s *jsiiProxy_SqlVisualization) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (s *jsiiProxy_SqlVisualization) ToHclTerraform() interface{} {
	var returns interface{}
...
func (s *jsiiProxy_SqlVisualization) ToMetadata() interface{} {
	var returns interface{}
...
func (s *jsiiProxy_SqlVisualization) ToString() *string {
	var returns *string
...
func (s *jsiiProxy_SqlVisualization) ToTerraform() interface{} {
	var returns interface{}
...
func (s *jsiiProxy_SqlVisualization) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
