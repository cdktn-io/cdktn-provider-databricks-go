...
func (s *jsiiProxy_SqlVisualization) validateAddMoveTargetParameters(moveTarget *string) error {
	if moveTarget == nil {
...
func (s *jsiiProxy_SqlVisualization) validateImportFromParameters(id *string) error {
	if id == nil {
...
func validateSqlVisualization_GenerateConfigForImportParameters(scope constructs.Construct, importToId *string, importFromId *string) error {
	if scope == nil {
...
func (j *jsiiProxy_SqlVisualization) validateSetLifecycleParameters(val *cdktn.TerraformResourceLifecycle) error {
	if err := _jsii_.ValidateStruct(val, func() string { return "parameter val" }); err != nil {
		return err
	}
