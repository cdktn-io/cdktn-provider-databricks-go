...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*SqlVisualization)(nil)).Elem(),
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "queryPlan", GoGetter: "QueryPlan"},
			_jsii_.MemberProperty{JsiiProperty: "queryPlanInput", GoGetter: "QueryPlanInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetQueryPlan", GoMethod: "ResetQueryPlan"},
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*SqlVisualizationConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktn/provider-databricks.sqlVisualization.SqlVisualizationProviderConfig",
		reflect.TypeOf((*SqlVisualizationProviderConfig)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktn/provider-databricks.sqlVisualization.SqlVisualizationProviderConfigOutputReference",
		reflect.TypeOf((*SqlVisualizationProviderConfigOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
