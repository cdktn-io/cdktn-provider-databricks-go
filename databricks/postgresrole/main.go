...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*PostgresRole)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*PostgresRoleConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktn/provider-databricks.postgresRole.PostgresRoleProviderConfig",
		reflect.TypeOf((*PostgresRoleProviderConfig)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktn/provider-databricks.postgresRole.PostgresRoleProviderConfigOutputReference",
		reflect.TypeOf((*PostgresRoleProviderConfigOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*PostgresRoleSpec)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktn/provider-databricks.postgresRole.PostgresRoleSpecAttributes",
		reflect.TypeOf((*PostgresRoleSpecAttributes)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktn/provider-databricks.postgresRole.PostgresRoleSpecAttributesOutputReference",
		reflect.TypeOf((*PostgresRoleSpecAttributesOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*PostgresRoleSpecOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*PostgresRoleStatus)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktn/provider-databricks.postgresRole.PostgresRoleStatusAttributes",
		reflect.TypeOf((*PostgresRoleStatusAttributes)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktn/provider-databricks.postgresRole.PostgresRoleStatusAttributesOutputReference",
		reflect.TypeOf((*PostgresRoleStatusAttributesOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberProperty{JsiiProperty: "bypassrls", GoGetter: "Bypassrls"},
			_jsii_.MemberProperty{JsiiProperty: "bypassrlsInput", GoGetter: "BypassrlsInput"},
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIndex", GoGetter: "ComplexObjectIndex"},
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*PostgresRoleStatusOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberProperty{JsiiProperty: "attributes", GoGetter: "Attributes"},
			_jsii_.MemberProperty{JsiiProperty: "attributesInput", GoGetter: "AttributesInput"},
			_jsii_.MemberProperty{JsiiProperty: "authMethod", GoGetter: "AuthMethod"},
