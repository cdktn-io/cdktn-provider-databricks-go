...
import (
	...
	"github.com/cdktn-io/cdktn-provider-databricks-go/databricks/v18/mwscredentials/internal"
	"github.com/open-constructs/cdk-terrain-go/cdktn"
)

// Represents a {@link https://registry.terraform.io/providers/databricks/databricks/1.125.0/docs/resources/mws_credentials databricks_mws_credentials}.
...
func (j *jsiiProxy_MwsCredentials) AccountIdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"accountIdInput",
...
func (j *jsiiProxy_MwsCredentials) Connection() interface{} {
...
func (j *jsiiProxy_MwsCredentials) ConstructNodeMetadata() *map[string]interface{} {
...
func (j *jsiiProxy_MwsCredentials) Count() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"count",
...
func (j *jsiiProxy_MwsCredentials) CreationTime() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
		"creationTime",
...
func (j *jsiiProxy_MwsCredentials) CredentialsName() *string {
	var returns *string
	_jsii_.Get(
		j,
		"credentialsName",
...
func (j *jsiiProxy_MwsCredentials) CredentialsNameInput() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_MwsCredentials) DependsOn() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"dependsOn",
...
func (j *jsiiProxy_MwsCredentials) ExternalId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"externalId",
...
func (j *jsiiProxy_MwsCredentials) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_MwsCredentials) FriendlyUniqueId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"friendlyUniqueId",
...
func (j *jsiiProxy_MwsCredentials) Id() *string {
	var returns *string
	_jsii_.Get(
		j,
		"id",
...
func (j *jsiiProxy_MwsCredentials) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func (j *jsiiProxy_MwsCredentials) Node() constructs.Node {
...
func (j *jsiiProxy_MwsCredentials) Provisioners() *[]interface{} {
	var returns *[]interface{}
	_jsii_.Get(
		j,
		"provisioners",
...
func (j *jsiiProxy_MwsCredentials) RawOverrides() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"rawOverrides",
...
func (j *jsiiProxy_MwsCredentials) RoleArn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"roleArn",
...
func (j *jsiiProxy_MwsCredentials) RoleArnInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"roleArnInput",
...
func (j *jsiiProxy_MwsCredentials) TerraformMetaArguments() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_MwsCredentials) TerraformResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
...
// Create a new {@link https://registry.terraform.io/providers/databricks/databricks/1.125.0/docs/resources/mws_credentials databricks_mws_credentials} Resource.
...
func (j *jsiiProxy_MwsCredentials)SetCount(val interface{}) {
...
// Experimental.
func MwsCredentials_IsTerraformElement(x interface{}) *bool {
	_init_.Initialize()

	if err := validateMwsCredentials_IsTerraformElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func MwsCredentials_IsTerraformResource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateMwsCredentials_IsTerraformResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func MwsCredentials_TfResourceType() *string {
	_init_.Initialize()
	var returns *string
	_jsii_.StaticGet(
		"@cdktn/provider-databricks.mwsCredentials.MwsCredentials",
...
func (m *jsiiProxy_MwsCredentials) AddMoveTarget(moveTarget *string) {
...
func (m *jsiiProxy_MwsCredentials) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (m *jsiiProxy_MwsCredentials) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (m *jsiiProxy_MwsCredentials) ResetId() {
	_jsii_.InvokeVoid(
		m,
		"resetId",
		nil, // no parameters
...
func (m *jsiiProxy_MwsCredentials) ResetOverrideLogicalId() {
	_jsii_.InvokeVoid(
		m,
		"resetOverrideLogicalId",
		nil, // no parameters
...
func (m *jsiiProxy_MwsCredentials) SynthesizeAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (m *jsiiProxy_MwsCredentials) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (m *jsiiProxy_MwsCredentials) ToHclTerraform() interface{} {
	var returns interface{}
...
func (m *jsiiProxy_MwsCredentials) ToMetadata() interface{} {
	var returns interface{}
...
func (m *jsiiProxy_MwsCredentials) ToString() *string {
	var returns *string
...
func (m *jsiiProxy_MwsCredentials) ToTerraform() interface{} {
	var returns interface{}
...
func (m *jsiiProxy_MwsCredentials) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
