...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*MwsCredentials)(nil)).Elem(),
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "credentialsName", GoGetter: "CredentialsName"},
			_jsii_.MemberProperty{JsiiProperty: "credentialsNameInput", GoGetter: "CredentialsNameInput"},
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*MwsCredentialsConfig)(nil)).Elem(),
	)
}
