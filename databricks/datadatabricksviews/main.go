...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataDatabricksViews)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*DataDatabricksViewsConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktn/provider-databricks.dataDatabricksViews.DataDatabricksViewsProviderConfig",
		reflect.TypeOf((*DataDatabricksViewsProviderConfig)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktn/provider-databricks.dataDatabricksViews.DataDatabricksViewsProviderConfigOutputReference",
		reflect.TypeOf((*DataDatabricksViewsProviderConfigOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
