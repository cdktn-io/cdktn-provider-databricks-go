...
// Represents a {@link https://registry.terraform.io/providers/databricks/databricks/1.126.0/docs/data-sources/postgres_project databricks_postgres_project}.
type DataDatabricksPostgresProject interface {
	...
	InitialBranchSpec() DataDatabricksPostgresProjectInitialBranchSpecOutputReference
...
func (j *jsiiProxy_DataDatabricksPostgresProject) InitialBranchSpec() DataDatabricksPostgresProjectInitialBranchSpecOutputReference {
	var returns DataDatabricksPostgresProjectInitialBranchSpecOutputReference
	_jsii_.Get(
		j,
		"initialBranchSpec",
		&returns,
...
func (j *jsiiProxy_DataDatabricksPostgresProject) ProjectId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"projectId",
...
// Create a new {@link https://registry.terraform.io/providers/databricks/databricks/1.126.0/docs/data-sources/postgres_project databricks_postgres_project} Data Source.
...
func (d *jsiiProxy_DataDatabricksPostgresProject) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
