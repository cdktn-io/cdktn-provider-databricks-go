...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "isMetaInstanceProfile", GoGetter: "IsMetaInstanceProfile"},
			_jsii_.MemberProperty{JsiiProperty: "isMetaInstanceProfileInput", GoGetter: "IsMetaInstanceProfileInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetIsMetaInstanceProfile", GoMethod: "ResetIsMetaInstanceProfile"},
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*InstanceProfileConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktn/provider-databricks.instanceProfile.InstanceProfileProviderConfig",
		reflect.TypeOf((*InstanceProfileProviderConfig)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktn/provider-databricks.instanceProfile.InstanceProfileProviderConfigOutputReference",
		reflect.TypeOf((*InstanceProfileProviderConfigOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
