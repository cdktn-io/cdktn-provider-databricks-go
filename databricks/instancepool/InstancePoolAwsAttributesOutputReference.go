...
// The jsii proxy struct for InstancePoolAwsAttributesOutputReference
type jsiiProxy_InstancePoolAwsAttributesOutputReference struct {
	internal.Type__cdktnComplexObject
}

func (j *jsiiProxy_InstancePoolAwsAttributesOutputReference) Availability() *string {
	var returns *string
	_jsii_.Get(
		j,
		"availability",
...
func (j *jsiiProxy_InstancePoolAwsAttributesOutputReference) AvailabilityInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"availabilityInput",
...
func (j *jsiiProxy_InstancePoolAwsAttributesOutputReference) ComplexObjectIndex() interface{} {
...
func (j *jsiiProxy_InstancePoolAwsAttributesOutputReference) ComplexObjectIsFromSet() *bool {
	var returns *bool
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_InstancePoolAwsAttributesOutputReference) CreationStack() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"creationStack",
...
func (j *jsiiProxy_InstancePoolAwsAttributesOutputReference) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_InstancePoolAwsAttributesOutputReference) InternalValue() *InstancePoolAwsAttributes {
...
func (j *jsiiProxy_InstancePoolAwsAttributesOutputReference) SpotBidPricePercent() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
		"spotBidPricePercent",
...
func (j *jsiiProxy_InstancePoolAwsAttributesOutputReference) SpotBidPricePercentInput() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_InstancePoolAwsAttributesOutputReference) TerraformAttribute() *string {
	var returns *string
	_jsii_.Get(
		j,
		"terraformAttribute",
...
func (j *jsiiProxy_InstancePoolAwsAttributesOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func (j *jsiiProxy_InstancePoolAwsAttributesOutputReference) ZoneId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"zoneId",
...
func (j *jsiiProxy_InstancePoolAwsAttributesOutputReference) ZoneIdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"zoneIdInput",
...
func NewInstancePoolAwsAttributesOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) InstancePoolAwsAttributesOutputReference {
	_init_.Initialize()
...
func NewInstancePoolAwsAttributesOutputReference_Override(i InstancePoolAwsAttributesOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_InstancePoolAwsAttributesOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (i *jsiiProxy_InstancePoolAwsAttributesOutputReference) ComputeFqn() *string {
	var returns *string
...
func (i *jsiiProxy_InstancePoolAwsAttributesOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (i *jsiiProxy_InstancePoolAwsAttributesOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (i *jsiiProxy_InstancePoolAwsAttributesOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (i *jsiiProxy_InstancePoolAwsAttributesOutputReference) ResetAvailability() {
	_jsii_.InvokeVoid(
		i,
		"resetAvailability",
		nil, // no parameters
...
func (i *jsiiProxy_InstancePoolAwsAttributesOutputReference) ResetSpotBidPricePercent() {
	_jsii_.InvokeVoid(
		i,
		"resetSpotBidPricePercent",
		nil, // no parameters
...
func (i *jsiiProxy_InstancePoolAwsAttributesOutputReference) ResetZoneId() {
	_jsii_.InvokeVoid(
		i,
		"resetZoneId",
		nil, // no parameters
...
func (i *jsiiProxy_InstancePoolAwsAttributesOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
...
func (i *jsiiProxy_InstancePoolAwsAttributesOutputReference) ToString() *string {
	var returns *string
