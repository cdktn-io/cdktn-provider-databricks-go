...
import (
	...
	"github.com/cdktn-io/cdktn-provider-databricks-go/databricks/v18/azureblobmount/internal"
	"github.com/open-constructs/cdk-terrain-go/cdktn"
)

// Represents a {@link https://registry.terraform.io/providers/databricks/databricks/1.128.0/docs/resources/azure_blob_mount databricks_azure_blob_mount}.
...
// Create a new {@link https://registry.terraform.io/providers/databricks/databricks/1.128.0/docs/resources/azure_blob_mount databricks_azure_blob_mount} Resource.
...
// Experimental.
func AzureBlobMount_IsTerraformElement(x interface{}) *bool {
	_init_.Initialize()

	if err := validateAzureBlobMount_IsTerraformElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func AzureBlobMount_IsTerraformResource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateAzureBlobMount_IsTerraformResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (a *jsiiProxy_AzureBlobMount) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (a *jsiiProxy_AzureBlobMount) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (a *jsiiProxy_AzureBlobMount) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (a *jsiiProxy_AzureBlobMount) ToHclTerraform() interface{} {
	var returns interface{}
...
func (a *jsiiProxy_AzureBlobMount) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
