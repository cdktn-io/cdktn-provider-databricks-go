...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataDatabricksSchemas)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*DataDatabricksSchemasConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktn/provider-databricks.dataDatabricksSchemas.DataDatabricksSchemasProviderConfig",
		reflect.TypeOf((*DataDatabricksSchemasProviderConfig)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktn/provider-databricks.dataDatabricksSchemas.DataDatabricksSchemasProviderConfigOutputReference",
		reflect.TypeOf((*DataDatabricksSchemasProviderConfigOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
