...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*Entitlements)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*EntitlementsConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktn/provider-databricks.entitlements.EntitlementsProviderConfig",
		reflect.TypeOf((*EntitlementsProviderConfig)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktn/provider-databricks.entitlements.EntitlementsProviderConfigOutputReference",
		reflect.TypeOf((*EntitlementsProviderConfigOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
