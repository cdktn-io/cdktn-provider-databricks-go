...
func (w *jsiiProxy_WorkspaceSettingV2AibiDashboardEmbeddingApprovedDomainsOutputReference) validateResolveParameters(context cdktn.IResolveContext) error {
	if context == nil {
...
func (j *jsiiProxy_WorkspaceSettingV2AibiDashboardEmbeddingApprovedDomainsOutputReference) validateSetInternalValueParameters(val interface{}) error {
	...
	default:
		if !_jsii_.IsAnonymousProxy(val) {
			return fmt.Errorf("parameter val must be one of the allowed types: cdktn.IResolvable, *WorkspaceSettingV2AibiDashboardEmbeddingApprovedDomains; received %#v (a %T)", val, val)
		}
	}
...
func (j *jsiiProxy_WorkspaceSettingV2AibiDashboardEmbeddingApprovedDomainsOutputReference) validateSetTerraformResourceParameters(val cdktn.IInterpolatingParent) error {
	if val == nil {
		return fmt.Errorf("parameter val is required, but nil was provided")
	}
...
func validateNewWorkspaceSettingV2AibiDashboardEmbeddingApprovedDomainsOutputReferenceParameters(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) error {
