...
func (f *jsiiProxy_File) validateMarkWriteOnlyAttributeParameters(value interface{}) error {
	return nil
}

func (f *jsiiProxy_File) validateMoveFromIdParameters(id *string) error {
	return nil
}
...
func (f *jsiiProxy_File) validateMoveToIdParameters(id *string) error {
	return nil
}
...
func (f *jsiiProxy_File) validatePutProviderConfigParameters(value *FileProviderConfig) error {
	return nil
}

func (f *jsiiProxy_File) validateRegisterProviderFeatureUsageParameters(feature cdktn.ProviderFeature) error {
	return nil
}
...
func (j *jsiiProxy_File) validateSetContentBase64Parameters(val *string) error {
	return nil
}
...
func (j *jsiiProxy_File) validateSetLifecycleParameters(val *cdktn.TerraformResourceLifecycle) error {
	return nil
}

func (j *jsiiProxy_File) validateSetMd5Parameters(val *string) error {
	return nil
}

func (j *jsiiProxy_File) validateSetPathParameters(val *string) error {
	return nil
}
...
func (j *jsiiProxy_File) validateSetRemoteFileModifiedParameters(val interface{}) error {
	return nil
}

func (j *jsiiProxy_File) validateSetSourceParameters(val *string) error {
	return nil
}
