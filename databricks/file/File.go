...
// Represents a {@link https://registry.terraform.io/providers/databricks/databricks/1.128.0/docs/resources/file databricks_file}.
type File interface {
	...
	ProviderConfig() FileProviderConfigOutputReference
	ProviderConfigInput() *FileProviderConfig
	// Experimental.
	...
	SetRemoteFileModified(val interface{})
	RemoteFileModifiedInput() interface{}
	Source() *string
	...
	PutProviderConfig(value *FileProviderConfig)
...
func (j *jsiiProxy_File) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_File) ContentBase64() *string {
	var returns *string
	_jsii_.Get(
		j,
		"contentBase64",
...
func (j *jsiiProxy_File) ContentBase64Input() *string {
	var returns *string
	_jsii_.Get(
		j,
		"contentBase64Input",
...
func (j *jsiiProxy_File) FileSize() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
		"fileSize",
...
func (j *jsiiProxy_File) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_File) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_File) Md5() *string {
	var returns *string
	_jsii_.Get(
		j,
		"md5",
...
func (j *jsiiProxy_File) Md5Input() *string {
	var returns *string
	_jsii_.Get(
		j,
		"md5Input",
...
func (j *jsiiProxy_File) ModificationTime() *string {
	var returns *string
	_jsii_.Get(
		j,
		"modificationTime",
...
func (j *jsiiProxy_File) Path() *string {
	var returns *string
	_jsii_.Get(
		j,
		"path",
...
func (j *jsiiProxy_File) PathInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"pathInput",
...
func (j *jsiiProxy_File) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_File) ProviderConfig() FileProviderConfigOutputReference {
	var returns FileProviderConfigOutputReference
	_jsii_.Get(
		j,
		"providerConfig",
		&returns,
...
func (j *jsiiProxy_File) ProviderConfigInput() *FileProviderConfig {
...
func (j *jsiiProxy_File) RemoteFileModified() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"remoteFileModified",
...
func (j *jsiiProxy_File) RemoteFileModifiedInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"remoteFileModifiedInput",
		&returns,
	)
	return returns
}

func (j *jsiiProxy_File) Source() *string {
	var returns *string
	_jsii_.Get(
		j,
		"source",
...
func (j *jsiiProxy_File) SourceInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"sourceInput",
...
func (j *jsiiProxy_File) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/databricks/databricks/1.128.0/docs/resources/file databricks_file} Resource.
...
func (j *jsiiProxy_File)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_File)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_File)SetMd5(val *string) {
...
func (j *jsiiProxy_File)SetPath(val *string) {
...
func (j *jsiiProxy_File)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func (j *jsiiProxy_File)SetRemoteFileModified(val interface{}) {
	if err := j.validateSetRemoteFileModifiedParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func File_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (f *jsiiProxy_File) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (f *jsiiProxy_File) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (f *jsiiProxy_File) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (f *jsiiProxy_File) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (f *jsiiProxy_File) PutProviderConfig(value *FileProviderConfig) {
...
func (f *jsiiProxy_File) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (f *jsiiProxy_File) ResetContentBase64() {
	_jsii_.InvokeVoid(
		f,
		"resetContentBase64",
		nil, // no parameters
...
func (f *jsiiProxy_File) ResetMd5() {
	_jsii_.InvokeVoid(
		f,
		"resetMd5",
		nil, // no parameters
...
func (f *jsiiProxy_File) ResetProviderConfig() {
	_jsii_.InvokeVoid(
		f,
		"resetProviderConfig",
		nil, // no parameters
...
func (f *jsiiProxy_File) ResetRemoteFileModified() {
	_jsii_.InvokeVoid(
		f,
		"resetRemoteFileModified",
		nil, // no parameters
