...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "remoteFileModified", GoGetter: "RemoteFileModified"},
			_jsii_.MemberProperty{JsiiProperty: "remoteFileModifiedInput", GoGetter: "RemoteFileModifiedInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetRemoteFileModified", GoMethod: "ResetRemoteFileModified"},
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*FileProviderConfig)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktn/provider-databricks.file.FileProviderConfigOutputReference",
		reflect.TypeOf((*FileProviderConfigOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
