...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "databricksE2AccountId", GoGetter: "DatabricksE2AccountId"},
			_jsii_.MemberProperty{JsiiProperty: "databricksE2AccountIdInput", GoGetter: "DatabricksE2AccountIdInput"},
			_jsii_.MemberProperty{JsiiProperty: "dependsOn", GoGetter: "DependsOn"},
			_jsii_.MemberProperty{JsiiProperty: "forEach", GoGetter: "ForEach"},
			_jsii_.MemberProperty{JsiiProperty: "fqn", GoGetter: "Fqn"},
			_jsii_.MemberProperty{JsiiProperty: "friendlyUniqueId", GoGetter: "FriendlyUniqueId"},
			_jsii_.MemberProperty{JsiiProperty: "fullAccessRole", GoGetter: "FullAccessRole"},
			_jsii_.MemberProperty{JsiiProperty: "fullAccessRoleInput", GoGetter: "FullAccessRoleInput"},
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*DataDatabricksAwsBucketPolicyConfig)(nil)).Elem(),
	)
}
