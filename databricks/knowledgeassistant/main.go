...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*KnowledgeAssistant)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*KnowledgeAssistantConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktn/provider-databricks.knowledgeAssistant.KnowledgeAssistantProviderConfig",
		reflect.TypeOf((*KnowledgeAssistantProviderConfig)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktn/provider-databricks.knowledgeAssistant.KnowledgeAssistantProviderConfigOutputReference",
		reflect.TypeOf((*KnowledgeAssistantProviderConfigOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
