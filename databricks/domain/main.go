...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "businessOwnerIdsInput", GoGetter: "BusinessOwnerIdsInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetBusinessOwnerIds", GoMethod: "ResetBusinessOwnerIds"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetTechnicalOwnerIds", GoMethod: "ResetTechnicalOwnerIds"},
			...
			_jsii_.MemberProperty{JsiiProperty: "technicalOwnerIdsInput", GoGetter: "TechnicalOwnerIdsInput"},
	...
	_jsii_.RegisterStruct(
		"@cdktn/provider-databricks.domain.DomainConfig",
		reflect.TypeOf((*DomainConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktn/provider-databricks.domain.DomainIcon",
		reflect.TypeOf((*DomainIcon)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktn/provider-databricks.domain.DomainIconOutputReference",
		reflect.TypeOf((*DomainIconOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"@cdktn/provider-databricks.domain.DomainProviderConfig",
		reflect.TypeOf((*DomainProviderConfig)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktn/provider-databricks.domain.DomainProviderConfigOutputReference",
		reflect.TypeOf((*DomainProviderConfigOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIndex", GoGetter: "ComplexObjectIndex"},
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIsFromSet", GoGetter: "ComplexObjectIsFromSet"},
			_jsii_.MemberMethod{JsiiMethod: "computeFqn", GoMethod: "ComputeFqn"},
		...
		func() interface{} {
			j := jsiiProxy_DomainProviderConfigOutputReference{}
			_jsii_.InitJsiiProxy(&j.Type__cdktnComplexObject)
			return &j
		},
	)
