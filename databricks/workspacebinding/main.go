...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*WorkspaceBinding)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*WorkspaceBindingConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktn/provider-databricks.workspaceBinding.WorkspaceBindingProviderConfig",
		reflect.TypeOf((*WorkspaceBindingProviderConfig)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktn/provider-databricks.workspaceBinding.WorkspaceBindingProviderConfigOutputReference",
		reflect.TypeOf((*WorkspaceBindingProviderConfigOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
