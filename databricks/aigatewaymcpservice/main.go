...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*AiGatewayMcpService)(nil)).Elem(),
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "mcpServiceId", GoGetter: "McpServiceId"},
			_jsii_.MemberProperty{JsiiProperty: "mcpServiceIdInput", GoGetter: "McpServiceIdInput"},
	...
	_jsii_.RegisterStruct(
		"@cdktn/provider-databricks.aiGatewayMcpService.AiGatewayMcpServiceConfig",
		reflect.TypeOf((*AiGatewayMcpServiceConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktn/provider-databricks.aiGatewayMcpService.AiGatewayMcpServiceConfigA",
		reflect.TypeOf((*AiGatewayMcpServiceConfigA)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktn/provider-databricks.aiGatewayMcpService.AiGatewayMcpServiceConfigAOutputReference",
		reflect.TypeOf((*AiGatewayMcpServiceConfigAOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"@cdktn/provider-databricks.aiGatewayMcpService.AiGatewayMcpServiceConfigRateLimits",
		reflect.TypeOf((*AiGatewayMcpServiceConfigRateLimits)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktn/provider-databricks.aiGatewayMcpService.AiGatewayMcpServiceConfigRateLimitsList",
		reflect.TypeOf((*AiGatewayMcpServiceConfigRateLimitsList)(nil)).Elem(),
		[]_jsii_.Member{
		...
		func() interface{} {
			j := jsiiProxy_AiGatewayMcpServiceConfigRateLimitsList{}
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*AiGatewayMcpServiceConfigRateLimitsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIndex", GoGetter: "ComplexObjectIndex"},
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIsFromSet", GoGetter: "ComplexObjectIsFromSet"},
			_jsii_.MemberMethod{JsiiMethod: "computeFqn", GoMethod: "ComputeFqn"},
	...
	_jsii_.RegisterStruct(
		"@cdktn/provider-databricks.aiGatewayMcpService.AiGatewayMcpServiceConfigSourceConnection",
		reflect.TypeOf((*AiGatewayMcpServiceConfigSourceConnection)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktn/provider-databricks.aiGatewayMcpService.AiGatewayMcpServiceConfigSourceConnectionOutputReference",
		reflect.TypeOf((*AiGatewayMcpServiceConfigSourceConnectionOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIndex", GoGetter: "ComplexObjectIndex"},
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIsFromSet", GoGetter: "ComplexObjectIsFromSet"},
			_jsii_.MemberMethod{JsiiMethod: "computeFqn", GoMethod: "ComputeFqn"},
	...
	_jsii_.RegisterStruct(
		"@cdktn/provider-databricks.aiGatewayMcpService.AiGatewayMcpServiceProviderConfig",
		reflect.TypeOf((*AiGatewayMcpServiceProviderConfig)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktn/provider-databricks.aiGatewayMcpService.AiGatewayMcpServiceProviderConfigOutputReference",
		reflect.TypeOf((*AiGatewayMcpServiceProviderConfigOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIndex", GoGetter: "ComplexObjectIndex"},
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIsFromSet", GoGetter: "ComplexObjectIsFromSet"},
			_jsii_.MemberMethod{JsiiMethod: "computeFqn", GoMethod: "ComputeFqn"},
		...
		func() interface{} {
			j := jsiiProxy_AiGatewayMcpServiceProviderConfigOutputReference{}
			_jsii_.InitJsiiProxy(&j.Type__cdktnComplexObject)
			return &j
		},
	)
