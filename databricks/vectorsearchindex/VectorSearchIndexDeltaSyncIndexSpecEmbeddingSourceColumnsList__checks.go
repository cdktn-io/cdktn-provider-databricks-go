...
func (v *jsiiProxy_VectorSearchIndexDeltaSyncIndexSpecEmbeddingSourceColumnsList) validateResolveParameters(context cdktn.IResolveContext) error {
	if context == nil {
...
func (j *jsiiProxy_VectorSearchIndexDeltaSyncIndexSpecEmbeddingSourceColumnsList) validateSetTerraformResourceParameters(val cdktn.IInterpolatingParent) error {
	if val == nil {
		return fmt.Errorf("parameter val is required, but nil was provided")
	}
...
func validateNewVectorSearchIndexDeltaSyncIndexSpecEmbeddingSourceColumnsListParameters(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) error {
