...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataDatabricksDatabaseDatabaseCatalog)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*DataDatabricksDatabaseDatabaseCatalogConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktn/provider-databricks.dataDatabricksDatabaseDatabaseCatalog.DataDatabricksDatabaseDatabaseCatalogProviderConfig",
		reflect.TypeOf((*DataDatabricksDatabaseDatabaseCatalogProviderConfig)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataDatabricksDatabaseDatabaseCatalogProviderConfigOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
