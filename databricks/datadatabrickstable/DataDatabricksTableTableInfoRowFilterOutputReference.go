...
type DataDatabricksTableTableInfoRowFilterOutputReference interface {
	...
	InternalValue() *DataDatabricksTableTableInfoRowFilter
	SetInternalValue(val *DataDatabricksTableTableInfoRowFilter)
	// Experimental.
...
func (j *jsiiProxy_DataDatabricksTableTableInfoRowFilterOutputReference) ComplexObjectIsFromSet() *bool {
	var returns *bool
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_DataDatabricksTableTableInfoRowFilterOutputReference) CreationStack() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"creationStack",
...
func (j *jsiiProxy_DataDatabricksTableTableInfoRowFilterOutputReference) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_DataDatabricksTableTableInfoRowFilterOutputReference) FunctionName() *string {
	var returns *string
	_jsii_.Get(
		j,
		"functionName",
...
func (j *jsiiProxy_DataDatabricksTableTableInfoRowFilterOutputReference) FunctionNameInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"functionNameInput",
...
func (j *jsiiProxy_DataDatabricksTableTableInfoRowFilterOutputReference) InputColumnNamesInput() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"inputColumnNamesInput",
		&returns,
	)
	return returns
}

func (j *jsiiProxy_DataDatabricksTableTableInfoRowFilterOutputReference) InternalValue() *DataDatabricksTableTableInfoRowFilter {
...
func (j *jsiiProxy_DataDatabricksTableTableInfoRowFilterOutputReference) TerraformAttribute() *string {
	var returns *string
	_jsii_.Get(
		j,
		"terraformAttribute",
...
func (j *jsiiProxy_DataDatabricksTableTableInfoRowFilterOutputReference)SetComplexObjectIndex(val interface{}) {
...
func (j *jsiiProxy_DataDatabricksTableTableInfoRowFilterOutputReference)SetComplexObjectIsFromSet(val *bool) {
...
func (j *jsiiProxy_DataDatabricksTableTableInfoRowFilterOutputReference)SetFunctionName(val *string) {
...
func (j *jsiiProxy_DataDatabricksTableTableInfoRowFilterOutputReference)SetInputColumnNames(val *[]*string) {
	if err := j.validateSetInputColumnNamesParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func (j *jsiiProxy_DataDatabricksTableTableInfoRowFilterOutputReference)SetInternalValue(val *DataDatabricksTableTableInfoRowFilter) {
...
func (j *jsiiProxy_DataDatabricksTableTableInfoRowFilterOutputReference)SetTerraformAttribute(val *string) {
...
func (d *jsiiProxy_DataDatabricksTableTableInfoRowFilterOutputReference) ComputeFqn() *string {
	var returns *string
...
func (d *jsiiProxy_DataDatabricksTableTableInfoRowFilterOutputReference) GetAnyMapAttribute(terraformAttribute *string) *map[string]interface{} {
...
func (d *jsiiProxy_DataDatabricksTableTableInfoRowFilterOutputReference) GetBooleanMapAttribute(terraformAttribute *string) *map[string]*bool {
...
func (d *jsiiProxy_DataDatabricksTableTableInfoRowFilterOutputReference) GetListAttribute(terraformAttribute *string) *[]*string {
...
func (d *jsiiProxy_DataDatabricksTableTableInfoRowFilterOutputReference) GetNumberAttribute(terraformAttribute *string) *float64 {
...
func (d *jsiiProxy_DataDatabricksTableTableInfoRowFilterOutputReference) GetNumberListAttribute(terraformAttribute *string) *[]*float64 {
...
func (d *jsiiProxy_DataDatabricksTableTableInfoRowFilterOutputReference) GetNumberMapAttribute(terraformAttribute *string) *map[string]*float64 {
...
func (d *jsiiProxy_DataDatabricksTableTableInfoRowFilterOutputReference) GetStringAttribute(terraformAttribute *string) *string {
...
func (d *jsiiProxy_DataDatabricksTableTableInfoRowFilterOutputReference) GetStringMapAttribute(terraformAttribute *string) *map[string]*string {
...
func (d *jsiiProxy_DataDatabricksTableTableInfoRowFilterOutputReference) ToString() *string {
	var returns *string
