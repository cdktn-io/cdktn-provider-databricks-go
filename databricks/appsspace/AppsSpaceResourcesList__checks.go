...
func (j *jsiiProxy_AppsSpaceResourcesList) validateSetInternalValueParameters(val interface{}) error {
	...
	case cdktn.IResolvable:
		// ok
	case *[]*AppsSpaceResources:
		val := val.(*[]*AppsSpaceResources)
	...
	default:
		if !_jsii_.IsAnonymousProxy(val) {
			return fmt.Errorf("parameter val must be one of the allowed types: cdktn.IResolvable, *[]*AppsSpaceResources; received %#v (a %T)", val, val)
		}
	}
