...
func (j *jsiiProxy_OnlineTableStatusContinuousUpdateStatusInitialPipelineSyncProgressList) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_OnlineTableStatusContinuousUpdateStatusInitialPipelineSyncProgressList) TerraformAttribute() *string {
	var returns *string
	_jsii_.Get(
		j,
		"terraformAttribute",
...
func (j *jsiiProxy_OnlineTableStatusContinuousUpdateStatusInitialPipelineSyncProgressList) WrapsSet() *bool {
	var returns *bool
	_jsii_.Get(
		j,
		"wrapsSet",
...
func (j *jsiiProxy_OnlineTableStatusContinuousUpdateStatusInitialPipelineSyncProgressList)SetTerraformAttribute(val *string) {
...
func (j *jsiiProxy_OnlineTableStatusContinuousUpdateStatusInitialPipelineSyncProgressList)SetWrapsSet(val *bool) {
...
func (o *jsiiProxy_OnlineTableStatusContinuousUpdateStatusInitialPipelineSyncProgressList) ComputeFqn() *string {
	var returns *string
...
func (o *jsiiProxy_OnlineTableStatusContinuousUpdateStatusInitialPipelineSyncProgressList) Get(index *float64) OnlineTableStatusContinuousUpdateStatusInitialPipelineSyncProgressOutputReference {
	if err := o.validateGetParameters(index); err != nil {
		panic(err)
	}
	var returns OnlineTableStatusContinuousUpdateStatusInitialPipelineSyncProgressOutputReference
...
func (o *jsiiProxy_OnlineTableStatusContinuousUpdateStatusInitialPipelineSyncProgressList) ToString() *string {
	var returns *string
