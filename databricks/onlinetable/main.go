...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "tableServingUrl", GoGetter: "TableServingUrl"},
	...
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberMethod{JsiiMethod: "interpolationAsList", GoMethod: "InterpolationAsList"},
			_jsii_.MemberMethod{JsiiMethod: "interpolationForAttribute", GoMethod: "InterpolationForAttribute"},
			_jsii_.MemberProperty{JsiiProperty: "performFullCopy", GoGetter: "PerformFullCopy"},
			_jsii_.MemberProperty{JsiiProperty: "performFullCopyInput", GoGetter: "PerformFullCopyInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "putRunContinuously", GoMethod: "PutRunContinuously"},
			_jsii_.MemberMethod{JsiiMethod: "putRunTriggered", GoMethod: "PutRunTriggered"},
			_jsii_.MemberMethod{JsiiMethod: "resetPerformFullCopy", GoMethod: "ResetPerformFullCopy"},
			_jsii_.MemberMethod{JsiiMethod: "resetPrimaryKeyColumns", GoMethod: "ResetPrimaryKeyColumns"},
			_jsii_.MemberMethod{JsiiMethod: "resetRunContinuously", GoMethod: "ResetRunContinuously"},
			_jsii_.MemberMethod{JsiiMethod: "resetRunTriggered", GoMethod: "ResetRunTriggered"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resolve", GoMethod: "Resolve"},
			_jsii_.MemberProperty{JsiiProperty: "runContinuously", GoGetter: "RunContinuously"},
			_jsii_.MemberProperty{JsiiProperty: "runContinuouslyInput", GoGetter: "RunContinuouslyInput"},
			_jsii_.MemberProperty{JsiiProperty: "runTriggered", GoGetter: "RunTriggered"},
			_jsii_.MemberProperty{JsiiProperty: "runTriggeredInput", GoGetter: "RunTriggeredInput"},
