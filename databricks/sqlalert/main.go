...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*SqlAlert)(nil)).Elem(),
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "rearm", GoGetter: "Rearm"},
			_jsii_.MemberProperty{JsiiProperty: "rearmInput", GoGetter: "RearmInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetRearm", GoMethod: "ResetRearm"},
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*SqlAlertConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktn/provider-databricks.sqlAlert.SqlAlertOptions",
		reflect.TypeOf((*SqlAlertOptions)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktn/provider-databricks.sqlAlert.SqlAlertOptionsOutputReference",
		reflect.TypeOf((*SqlAlertOptionsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "customBody", GoGetter: "CustomBody"},
			_jsii_.MemberProperty{JsiiProperty: "customBodyInput", GoGetter: "CustomBodyInput"},
			...
			_jsii_.MemberProperty{JsiiProperty: "mutedInput", GoGetter: "MutedInput"},
			_jsii_.MemberProperty{JsiiProperty: "op", GoGetter: "Op"},
			_jsii_.MemberProperty{JsiiProperty: "opInput", GoGetter: "OpInput"},
			_jsii_.MemberMethod{JsiiMethod: "resetCustomBody", GoMethod: "ResetCustomBody"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetMuted", GoMethod: "ResetMuted"},
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*SqlAlertProviderConfig)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktn/provider-databricks.sqlAlert.SqlAlertProviderConfigOutputReference",
		reflect.TypeOf((*SqlAlertProviderConfigOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIndex", GoGetter: "ComplexObjectIndex"},
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIsFromSet", GoGetter: "ComplexObjectIsFromSet"},
			_jsii_.MemberMethod{JsiiMethod: "computeFqn", GoMethod: "ComputeFqn"},
