...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*EnvironmentsWorkspaceBaseEnvironment)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberMethod{JsiiMethod: "addMoveTarget", GoMethod: "AddMoveTarget"},
			_jsii_.MemberMethod{JsiiMethod: "addOverride", GoMethod: "AddOverride"},
			_jsii_.MemberProperty{JsiiProperty: "baseEnvironmentType", GoGetter: "BaseEnvironmentType"},
			_jsii_.MemberProperty{JsiiProperty: "baseEnvironmentTypeInput", GoGetter: "BaseEnvironmentTypeInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetBaseEnvironmentType", GoMethod: "ResetBaseEnvironmentType"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetWorkspaceBaseEnvironmentId", GoMethod: "ResetWorkspaceBaseEnvironmentId"},
			...
			_jsii_.MemberProperty{JsiiProperty: "workspaceBaseEnvironmentId", GoGetter: "WorkspaceBaseEnvironmentId"},
			_jsii_.MemberProperty{JsiiProperty: "workspaceBaseEnvironmentIdInput", GoGetter: "WorkspaceBaseEnvironmentIdInput"},
		},
		func() interface{} {
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*EnvironmentsWorkspaceBaseEnvironmentConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktn/provider-databricks.environmentsWorkspaceBaseEnvironment.EnvironmentsWorkspaceBaseEnvironmentProviderConfig",
		reflect.TypeOf((*EnvironmentsWorkspaceBaseEnvironmentProviderConfig)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*EnvironmentsWorkspaceBaseEnvironmentProviderConfigOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"@cdktn/provider-databricks.environmentsWorkspaceBaseEnvironment.EnvironmentsWorkspaceBaseEnvironmentSpec",
		reflect.TypeOf((*EnvironmentsWorkspaceBaseEnvironmentSpec)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktn/provider-databricks.environmentsWorkspaceBaseEnvironment.EnvironmentsWorkspaceBaseEnvironmentSpecOutputReference",
		reflect.TypeOf((*EnvironmentsWorkspaceBaseEnvironmentSpecOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIndex", GoGetter: "ComplexObjectIndex"},
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIsFromSet", GoGetter: "ComplexObjectIsFromSet"},
			_jsii_.MemberMethod{JsiiMethod: "computeFqn", GoMethod: "ComputeFqn"},
