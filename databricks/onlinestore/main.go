...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*OnlineStore)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*OnlineStoreConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktn/provider-databricks.onlineStore.OnlineStoreProviderConfig",
		reflect.TypeOf((*OnlineStoreProviderConfig)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktn/provider-databricks.onlineStore.OnlineStoreProviderConfigOutputReference",
		reflect.TypeOf((*OnlineStoreProviderConfigOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
