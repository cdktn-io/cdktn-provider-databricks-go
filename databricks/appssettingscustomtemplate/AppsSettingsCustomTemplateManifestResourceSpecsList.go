...
func (j *jsiiProxy_AppsSettingsCustomTemplateManifestResourceSpecsList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewAppsSettingsCustomTemplateManifestResourceSpecsList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) AppsSettingsCustomTemplateManifestResourceSpecsList {
	_init_.Initialize()
...
func NewAppsSettingsCustomTemplateManifestResourceSpecsList_Override(a AppsSettingsCustomTemplateManifestResourceSpecsList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_AppsSettingsCustomTemplateManifestResourceSpecsList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (a *jsiiProxy_AppsSettingsCustomTemplateManifestResourceSpecsList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (a *jsiiProxy_AppsSettingsCustomTemplateManifestResourceSpecsList) Resolve(context cdktn.IResolveContext) interface{} {
