...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataDatabricksAwsUnityCatalogPolicy)(nil)).Elem(),
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "kmsName", GoGetter: "KmsName"},
			_jsii_.MemberProperty{JsiiProperty: "kmsNameInput", GoGetter: "KmsNameInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetKmsName", GoMethod: "ResetKmsName"},
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*DataDatabricksAwsUnityCatalogPolicyConfig)(nil)).Elem(),
	)
}
